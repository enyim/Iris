...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class Cast
  {
    ...
    public record SinksUpdated(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Cast.SinkType> Sinks
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Cast.EnableRequest Enable(string? PresentationUrl = default)    
    {
      return new Enyim.Iris.Protocol.Cast.EnableRequest(PresentationUrl);
    }
    /// <summary>
    /// Starts observing for sinks that can be used for tab mirroring, and if set,<br/>
    /// sinks compatible with |presentationUrl| as well. When sinks are found, a<br/>
    ...
    public static Enyim.Iris.Protocol.Cast.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Cast.DisableRequest();
    }
    /// <summary>Stops observing for sinks and issues.</summary>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Cast.SetSinkToUseRequest SetSinkToUse(string SinkName)    
    {
      return new Enyim.Iris.Protocol.Cast.SetSinkToUseRequest(SinkName);
    }
    /// <summary>
    /// Sets a sink to be used when the web page requests the browser to choose a<br/>
    /// sink via Presentation API, Remote Playback API, or Cast SDK.<br/>
    ...
    public static Enyim.Iris.Protocol.Cast.StartDesktopMirroringRequest StartDesktopMirroring(string SinkName)    
    {
      return new Enyim.Iris.Protocol.Cast.StartDesktopMirroringRequest(SinkName);
    }
    /// <summary>Starts mirroring the desktop to the sink.</summary>
    ...
    public static Enyim.Iris.Protocol.Cast.StartTabMirroringRequest StartTabMirroring(string SinkName)    
    {
      return new Enyim.Iris.Protocol.Cast.StartTabMirroringRequest(SinkName);
    }
    /// <summary>Starts mirroring the tab to the sink.</summary>
    ...
    public static Enyim.Iris.Protocol.Cast.StopCastingRequest StopCasting(string SinkName)    
    {
      return new Enyim.Iris.Protocol.Cast.StopCastingRequest(SinkName);
    }
    /// <summary>Stops the active Cast session on the sink.</summary>
