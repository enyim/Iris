...
namespace Enyim.Iris.Protocol
{
  public static partial class Tracing
  {
    ...
    public record TraceConfigType(
      ...
      Enyim.Iris.Protocol.Tracing.MemoryDumpConfigType? MemoryDumpConfig = default
    ...
    public record TracingComplete(
      ...
      Enyim.Iris.Protocol.Tracing.StreamFormatType? TraceFormat = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("streamCompression")]
      Enyim.Iris.Protocol.Tracing.StreamCompressionType? StreamCompression = default
    ) : ChromeProtocol.Core.IEvent
    {
    }
    /// <summary>Stop trace events collection.</summary>
    public static Enyim.Iris.Protocol.Tracing.EndRequest End()    
    {
      return new Enyim.Iris.Protocol.Tracing.EndRequest();
    }
    /// <summary>Stop trace events collection.</summary>
    ...
    public static Enyim.Iris.Protocol.Tracing.GetCategoriesRequest GetCategories()    
    {
      return new Enyim.Iris.Protocol.Tracing.GetCategoriesRequest();
    }
    /// <summary>Gets supported tracing categories.</summary>
    ...
    /// <summary>Return a descriptor for all available tracing categories.</summary>
    public static Enyim.Iris.Protocol.Tracing.GetTrackEventDescriptorRequest GetTrackEventDescriptor()    
    {
      return new Enyim.Iris.Protocol.Tracing.GetTrackEventDescriptorRequest();
    }
    /// <summary>Return a descriptor for all available tracing categories.</summary>
    [ChromeProtocol.Core.MethodName("Tracing.getTrackEventDescriptor")]
    public record GetTrackEventDescriptorRequest() : ChromeProtocol.Core.ICommand<GetTrackEventDescriptorRequestResult>
    {
    }
    ...
    public record GetTrackEventDescriptorRequestResult(
      [property: System.Text.Json.Serialization.JsonPropertyName("descriptor")]
      string Descriptor
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public static Enyim.Iris.Protocol.Tracing.RecordClockSyncMarkerRequest RecordClockSyncMarker(string SyncId)    
    {
      return new Enyim.Iris.Protocol.Tracing.RecordClockSyncMarkerRequest(SyncId);
    }
    /// <summary>Record a clock sync marker in the trace.</summary>
    /// <param name="SyncId">The ID of this clock sync marker</param>
    ...
    public static Enyim.Iris.Protocol.Tracing.RequestMemoryDumpRequest RequestMemoryDump(bool? Deterministic = default, Enyim.Iris.Protocol.Tracing.MemoryDumpLevelOfDetailType? LevelOfDetail = default)    
    {
      return new Enyim.Iris.Protocol.Tracing.RequestMemoryDumpRequest(Deterministic, LevelOfDetail);
    }
    /// <summary>Request a global memory dump.</summary>
    /// <param name="Deterministic">Enables more deterministic results by forcing garbage collection</param>
    /// <param name="LevelOfDetail">Specifies level of details in memory dump. Defaults to &quot;detailed&quot;.</param>
    ...
    public record RequestMemoryDumpRequest(
      ...
      Enyim.Iris.Protocol.Tracing.MemoryDumpLevelOfDetailType? LevelOfDetail = default
    ...
    public static Enyim.Iris.Protocol.Tracing.StartRequest Start(string? Categories = default, string? Options = default, double? BufferUsageReportingInterval = default, string? TransferMode = default, Enyim.Iris.Protocol.Tracing.StreamFormatType? StreamFormat = default, Enyim.Iris.Protocol.Tracing.StreamCompressionType? StreamCompression = default, Enyim.Iris.Protocol.Tracing.TraceConfigType? TraceConfig = default, string? PerfettoConfig = default, Enyim.Iris.Protocol.Tracing.TracingBackendType? TracingBackend = default)    
    {
      return new Enyim.Iris.Protocol.Tracing.StartRequest(Categories, Options, BufferUsageReportingInterval, TransferMode, StreamFormat, StreamCompression, TraceConfig, PerfettoConfig, TracingBackend);
    }
    /// <summary>Start trace events collection.</summary>
    /// <param name="Categories">Category/tag filter</param>
    /// <param name="Options">Tracing options</param>
    ...
    public record StartRequest(
      ...
      Enyim.Iris.Protocol.Tracing.StreamFormatType? StreamFormat = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("streamCompression")]
      Enyim.Iris.Protocol.Tracing.StreamCompressionType? StreamCompression = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("traceConfig")]
      Enyim.Iris.Protocol.Tracing.TraceConfigType? TraceConfig = default,
      ...
      Enyim.Iris.Protocol.Tracing.TracingBackendType? TracingBackend = default
