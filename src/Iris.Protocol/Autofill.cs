...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class Autofill
  {
    ...
    /// <param name="Name">
    /// address field name, for example GIVEN_NAME.<br/>
    /// The full list of supported field names:<br/>
    /// https://source.chromium.org/chromium/chromium/src/+/main:components/autofill/core/browser/field_types.cc;l=38<br/>
    /// </param>
    ...
    public record AddressFieldsType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Autofill.AddressFieldType> Fields
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record AddressUIType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Autofill.AddressFieldsType> AddressFields
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record FilledFieldType(
      ...
      Enyim.Iris.Protocol.Autofill.FillingStrategyType FillingStrategy,
      ...
      Enyim.Iris.Protocol.DOM.BackendNodeIdType FieldId
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record AddressFormFilled(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Autofill.FilledFieldType> FilledFields,
      [property: System.Text.Json.Serialization.JsonPropertyName("addressUi")]
      Enyim.Iris.Protocol.Autofill.AddressUIType AddressUi
    ...
    public static Enyim.Iris.Protocol.Autofill.TriggerRequest Trigger(Enyim.Iris.Protocol.DOM.BackendNodeIdType FieldId, Enyim.Iris.Protocol.Page.FrameIdType? FrameId = default, Enyim.Iris.Protocol.Autofill.CreditCardType? Card = default, Enyim.Iris.Protocol.Autofill.AddressType? Address = default)    
    {
      return new Enyim.Iris.Protocol.Autofill.TriggerRequest(FieldId, FrameId, Card, Address);
    }
    /// <summary>
    /// Trigger autofill on a form identified by the fieldId.<br/>
    /// If the field and related form cannot be autofilled, returns an error.<br/>
    ...
    public record TriggerRequest(
      ...
      Enyim.Iris.Protocol.Autofill.CreditCardType? Card = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("address")]
      Enyim.Iris.Protocol.Autofill.AddressType? Address = default
    ...
    public static Enyim.Iris.Protocol.Autofill.SetAddressesRequest SetAddresses(System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Autofill.AddressType> Addresses)    
    {
      return new Enyim.Iris.Protocol.Autofill.SetAddressesRequest(Addresses);
    }
    /// <summary>Set addresses so that developers can verify their forms implementation.</summary>
    ...
    public record SetAddressesRequest(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Autofill.AddressType> Addresses
    ...
    public static Enyim.Iris.Protocol.Autofill.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Autofill.DisableRequest();
    }
    /// <summary>Disables autofill domain notifications.</summary>
    ...
    public static Enyim.Iris.Protocol.Autofill.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.Autofill.EnableRequest();
    }
    /// <summary>Enables autofill domain notifications.</summary>
