...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class Media
  {
    ...
    public record PlayerEventType(
      ...
      Enyim.Iris.Protocol.Media.TimestampType Timestamp,
      [property: System.Text.Json.Serialization.JsonPropertyName("value")]
      string Value
    ) : ChromeProtocol.Core.IType
    {
    ...
    public record PlayerErrorType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Media.PlayerErrorSourceLocationType> Stack,
      [property: System.Text.Json.Serialization.JsonPropertyName("cause")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Media.PlayerErrorType> Cause,
    ...
    public record PlayerType(
      ...
      Enyim.Iris.Protocol.Media.PlayerIdType PlayerId,
      [property: System.Text.Json.Serialization.JsonPropertyName("domNodeId")]
      Enyim.Iris.Protocol.DOM.BackendNodeIdType? DomNodeId = default
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>
    ...
    public record PlayerPropertiesChanged(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Media.PlayerPropertyType> Properties
    ...
    public record PlayerEventsAdded(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Media.PlayerEventType> Events
    ) : ChromeProtocol.Core.IEvent
    {
    }
    ...
    public record PlayerMessagesLogged(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Media.PlayerMessageType> Messages
    ) : ChromeProtocol.Core.IEvent
    {
    }
    ...
    public record PlayerErrorsRaised(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Media.PlayerErrorType> Errors
    ) : ChromeProtocol.Core.IEvent
    {
    }
    /// <summary>
    ...
    /// event for each active player.<br/>
    /// </summary>
    [ChromeProtocol.Core.MethodName("Media.playerCreated")]
    public record PlayerCreated(
      [property: System.Text.Json.Serialization.JsonPropertyName("player")]
      Enyim.Iris.Protocol.Media.PlayerType Player
    ) : ChromeProtocol.Core.IEvent
    {
    }
    /// <summary>Enables the Media domain</summary>
    public static Enyim.Iris.Protocol.Media.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.Media.EnableRequest();
    }
    /// <summary>Enables the Media domain</summary>
    ...
    public static Enyim.Iris.Protocol.Media.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Media.DisableRequest();
    }
    /// <summary>Disables the Media domain.</summary>
