...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class Tethering
  {
    ...
    public static Enyim.Iris.Protocol.Tethering.BindRequest Bind(int Port)    
    {
      return new Enyim.Iris.Protocol.Tethering.BindRequest(Port);
    }
    /// <summary>Request browser port binding.</summary>
    /// <param name="Port">Port number to bind.</param>
    ...
    public static Enyim.Iris.Protocol.Tethering.UnbindRequest Unbind(int Port)    
    {
      return new Enyim.Iris.Protocol.Tethering.UnbindRequest(Port);
    }
    /// <summary>Request browser port unbinding.</summary>
    /// <param name="Port">Port number to unbind.</param>
