...
namespace Enyim.Iris.Protocol
{
  public static partial class Profiler
  {
    ...
    public record ProfileNodeType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Profiler.PositionTickInfoType>? PositionTicks = default
    ...
    public record ProfileType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Profiler.ProfileNodeType> Nodes,
    ...
    public record FunctionCoverageType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Profiler.CoverageRangeType> Ranges,
    ...
    public record ScriptCoverageType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Profiler.FunctionCoverageType> Functions
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record ConsoleProfileFinished(
      ...
      Enyim.Iris.Protocol.Profiler.ProfileType Profile,
    ...
    public record PreciseCoverageDeltaUpdate(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Profiler.ScriptCoverageType> Result
    ) : ChromeProtocol.Core.IEvent
    {
    }
    public static Enyim.Iris.Protocol.Profiler.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Profiler.DisableRequest();
    }
    ...
    public static Enyim.Iris.Protocol.Profiler.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.Profiler.EnableRequest();
    }
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Profiler.GetBestEffortCoverageRequest GetBestEffortCoverage()    
    {
      return new Enyim.Iris.Protocol.Profiler.GetBestEffortCoverageRequest();
    }
    /// <summary>
    /// Collect coverage data for the current isolate. The coverage data may be incomplete due to<br/>
    /// garbage collection.<br/>
    ...
    public static Enyim.Iris.Protocol.Profiler.SetSamplingIntervalRequest SetSamplingInterval(int Interval)    
    {
      return new Enyim.Iris.Protocol.Profiler.SetSamplingIntervalRequest(Interval);
    }
    /// <summary>Changes CPU profiler sampling interval. Must be called before CPU profiles recording started.</summary>
    /// <param name="Interval">New sampling interval in microseconds.</param>
    ...
    public static Enyim.Iris.Protocol.Profiler.StartRequest Start()    
    {
      return new Enyim.Iris.Protocol.Profiler.StartRequest();
    }
    ...
    public static Enyim.Iris.Protocol.Profiler.StartPreciseCoverageRequest StartPreciseCoverage(bool? CallCount = default, bool? Detailed = default, bool? AllowTriggeredUpdates = default)    
    {
      return new Enyim.Iris.Protocol.Profiler.StartPreciseCoverageRequest(CallCount, Detailed, AllowTriggeredUpdates);
    }
    /// <summary>
    /// Enable precise code coverage. Coverage data for JavaScript executed before enabling precise code<br/>
    /// coverage may be incomplete. Enabling prevents running optimized code and resets execution<br/>
    ...
    public static Enyim.Iris.Protocol.Profiler.StopRequest Stop()    
    {
      return new Enyim.Iris.Protocol.Profiler.StopRequest();
    }
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Profiler.StopPreciseCoverageRequest StopPreciseCoverage()    
    {
      return new Enyim.Iris.Protocol.Profiler.StopPreciseCoverageRequest();
    }
    /// <summary>
    /// Disable precise code coverage. Disabling releases unnecessary execution count records and allows<br/>
    /// executing optimized code.<br/>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Profiler.TakePreciseCoverageRequest TakePreciseCoverage()    
    {
      return new Enyim.Iris.Protocol.Profiler.TakePreciseCoverageRequest();
    }
    /// <summary>
    /// Collect coverage data for the current isolate, and resets execution counters. Precise code<br/>
    /// coverage needs to have started.<br/>
