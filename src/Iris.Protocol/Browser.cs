...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class Browser
  {
    ...
    public record BoundsType(
      ...
      Enyim.Iris.Protocol.Browser.WindowStateType? WindowState = default
    ...
    public record HistogramType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Browser.BucketType> Buckets
    ) : ChromeProtocol.Core.IType
    {
    }
    [System.Text.Json.Serialization.JsonConverter(typeof(ChromeProtocol.Core.PrimitiveTypeConverter))]
    public record PrivacySandboxAPIType(
      string Value
    ) : ChromeProtocol.Core.PrimitiveType<string>(Value)
    {
    }
    ...
    /// <param name="FilePath">
    /// If download is &quot;completed&quot;, provides the path of the downloaded file.<br/>
    /// Depending on the platform, it is not guaranteed to be set, nor the file<br/>
    /// is guaranteed to exist.<br/>
    /// </param>
    ...
    public record DownloadProgress(
      ...
      string State,
      [property: System.Text.Json.Serialization.JsonPropertyName("filePath")]
    ...
    /// Embedded origin the permission applies to. It is ignored unless the embedding origin is<br/>
    /// present and valid. If the embedding origin is provided but the embedded origin isn&#39;t, the<br/>
    /// embedding origin is used as the embedded origin.<br/>
    /// </param>
    /// <param name="BrowserContextId">Context to override. When omitted, default browser context is used.</param>
    public static Enyim.Iris.Protocol.Browser.SetPermissionRequest SetPermission(Enyim.Iris.Protocol.Browser.PermissionDescriptorType Permission, Enyim.Iris.Protocol.Browser.PermissionSettingType Setting, string? Origin = default, string? EmbeddedOrigin = default, Enyim.Iris.Protocol.Browser.BrowserContextIDType? BrowserContextId = default)    
    {
      return new Enyim.Iris.Protocol.Browser.SetPermissionRequest(Permission, Setting, Origin, EmbeddedOrigin, BrowserContextId);
    }
    /// <summary>Set permission settings for given embedding and embedded origins.</summary>
    /// <param name="Permission">Descriptor of permission to override.</param>
    /// <param name="Setting">Setting of the permission.</param>
    ...
    public record SetPermissionRequest(
      ...
      Enyim.Iris.Protocol.Browser.PermissionDescriptorType Permission,
      [property: System.Text.Json.Serialization.JsonPropertyName("setting")]
      Enyim.Iris.Protocol.Browser.PermissionSettingType Setting,
      [property: System.Text.Json.Serialization.JsonPropertyName("origin")]
      string? Origin = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("embeddedOrigin")]
      string? EmbeddedOrigin = default,
    ...
    public static Enyim.Iris.Protocol.Browser.GrantPermissionsRequest GrantPermissions(System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Browser.PermissionTypeType> Permissions, string? Origin = default, Enyim.Iris.Protocol.Browser.BrowserContextIDType? BrowserContextId = default)    
    {
      return new Enyim.Iris.Protocol.Browser.GrantPermissionsRequest(Permissions, Origin, BrowserContextId);
    }
    /// <summary>
    /// Grant specific permissions to the given origin and reject all others. Deprecated. Use<br/>
    /// setPermission instead.<br/>
    ...
    public record GrantPermissionsRequest(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Browser.PermissionTypeType> Permissions,
      [property: System.Text.Json.Serialization.JsonPropertyName("origin")]
      string? Origin = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("browserContextId")]
      Enyim.Iris.Protocol.Browser.BrowserContextIDType? BrowserContextId = default
    ...
    public static Enyim.Iris.Protocol.Browser.ResetPermissionsRequest ResetPermissions(Enyim.Iris.Protocol.Browser.BrowserContextIDType? BrowserContextId = default)    
    {
      return new Enyim.Iris.Protocol.Browser.ResetPermissionsRequest(BrowserContextId);
    }
    /// <summary>Reset all permission management for all origins.</summary>
    /// <param name="BrowserContextId">BrowserContext to reset permissions. When omitted, default browser context is used.</param>
    ...
    public static Enyim.Iris.Protocol.Browser.SetDownloadBehaviorRequest SetDownloadBehavior(string Behavior, Enyim.Iris.Protocol.Browser.BrowserContextIDType? BrowserContextId = default, string? DownloadPath = default, bool? EventsEnabled = default)    
    {
      return new Enyim.Iris.Protocol.Browser.SetDownloadBehaviorRequest(Behavior, BrowserContextId, DownloadPath, EventsEnabled);
    }
    /// <summary>Set the behavior when downloading a file.</summary>
    /// <param name="Behavior">
    /// Whether to allow all or deny all download requests, or use default Chrome behavior if<br/>
    ...
    public static Enyim.Iris.Protocol.Browser.CancelDownloadRequest CancelDownload(string Guid, Enyim.Iris.Protocol.Browser.BrowserContextIDType? BrowserContextId = default)    
    {
      return new Enyim.Iris.Protocol.Browser.CancelDownloadRequest(Guid, BrowserContextId);
    }
    /// <summary>Cancel a download if in progress</summary>
    /// <param name="Guid">Global unique identifier of the download.</param>
    /// <param name="BrowserContextId">BrowserContext to perform the action in. When omitted, default browser context is used.</param>
    ...
    public static Enyim.Iris.Protocol.Browser.CloseRequest Close()    
    {
      return new Enyim.Iris.Protocol.Browser.CloseRequest();
    }
    /// <summary>Close browser gracefully.</summary>
    ...
    public static Enyim.Iris.Protocol.Browser.CrashRequest Crash()    
    {
      return new Enyim.Iris.Protocol.Browser.CrashRequest();
    }
    /// <summary>Crashes browser on the main thread.</summary>
    ...
    public static Enyim.Iris.Protocol.Browser.CrashGpuProcessRequest CrashGpuProcess()    
    {
      return new Enyim.Iris.Protocol.Browser.CrashGpuProcessRequest();
    }
    /// <summary>Crashes GPU process.</summary>
    ...
    public static Enyim.Iris.Protocol.Browser.GetVersionRequest GetVersion()    
    {
      return new Enyim.Iris.Protocol.Browser.GetVersionRequest();
    }
    /// <summary>Returns version information.</summary>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Browser.GetBrowserCommandLineRequest GetBrowserCommandLine()    
    {
      return new Enyim.Iris.Protocol.Browser.GetBrowserCommandLineRequest();
    }
    /// <summary>
    /// Returns the command line switches for the browser process if, and only if<br/>
    /// --enable-automation is on the commandline.<br/>
    ...
    public static Enyim.Iris.Protocol.Browser.GetHistogramsRequest GetHistograms(string? Query = default, bool? Delta = default)    
    {
      return new Enyim.Iris.Protocol.Browser.GetHistogramsRequest(Query, Delta);
    }
    /// <summary>Get Chrome histograms.</summary>
    /// <param name="Query">
    /// Requested substring in name. Only histograms which have query as a<br/>
    ...
    public record GetHistogramsRequestResult(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Browser.HistogramType> Histograms
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    /// <param name="Delta">If true, retrieve delta since last delta call.</param>
    public static Enyim.Iris.Protocol.Browser.GetHistogramRequest GetHistogram(string Name, bool? Delta = default)    
    {
      return new Enyim.Iris.Protocol.Browser.GetHistogramRequest(Name, Delta);
    }
    /// <summary>Get a Chrome histogram by name.</summary>
    /// <param name="Name">Requested histogram name.</param>
    /// <param name="Delta">If true, retrieve delta since last delta call.</param>
    ...
    public record GetHistogramRequestResult(
      ...
      Enyim.Iris.Protocol.Browser.HistogramType Histogram
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>Get position and size of the browser window.</summary>
    /// <param name="WindowId">Browser window id.</param>
    public static Enyim.Iris.Protocol.Browser.GetWindowBoundsRequest GetWindowBounds(Enyim.Iris.Protocol.Browser.WindowIDType WindowId)    
    {
      return new Enyim.Iris.Protocol.Browser.GetWindowBoundsRequest(WindowId);
    }
    /// <summary>Get position and size of the browser window.</summary>
    /// <param name="WindowId">Browser window id.</param>
    ...
    public record GetWindowBoundsRequest(
      ...
      Enyim.Iris.Protocol.Browser.WindowIDType WindowId
    ...
    public record GetWindowBoundsRequestResult(
      ...
      Enyim.Iris.Protocol.Browser.BoundsType Bounds
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public static Enyim.Iris.Protocol.Browser.GetWindowForTargetRequest GetWindowForTarget(Enyim.Iris.Protocol.Target.TargetIDType? TargetId = default)    
    {
      return new Enyim.Iris.Protocol.Browser.GetWindowForTargetRequest(TargetId);
    }
    /// <summary>Get the browser window that contains the devtools target.</summary>
    /// <param name="TargetId">Devtools agent host id. If called as a part of the session, associated targetId is used.</param>
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Browser.SetWindowBoundsRequest SetWindowBounds(Enyim.Iris.Protocol.Browser.WindowIDType WindowId, Enyim.Iris.Protocol.Browser.BoundsType Bounds)    
    {
      return new Enyim.Iris.Protocol.Browser.SetWindowBoundsRequest(WindowId, Bounds);
    }
    /// <summary>Set position and/or size of the browser window.</summary>
    /// <param name="WindowId">Browser window id.</param>
    /// <param name="Bounds">
    ...
    /// <param name="WindowId">Browser window id.</param>
    /// <param name="Width">
    /// The window contents width in DIP. Assumes current width if omitted.<br/>
    /// Must be specified if &#39;height&#39; is omitted.<br/>
    /// </param>
    /// <param name="Height">
    /// The window contents height in DIP. Assumes current height if omitted.<br/>
    /// Must be specified if &#39;width&#39; is omitted.<br/>
    /// </param>
    public static Enyim.Iris.Protocol.Browser.SetContentsSizeRequest SetContentsSize(Enyim.Iris.Protocol.Browser.WindowIDType WindowId, int? Width = default, int? Height = default)    
    {
      return new Enyim.Iris.Protocol.Browser.SetContentsSizeRequest(WindowId, Width, Height);
    }
    /// <summary>Set size of the browser contents resizing browser window as necessary.</summary>
    /// <param name="WindowId">Browser window id.</param>
    /// <param name="Width">
    ...
    /// Must be specified if &#39;width&#39; is omitted.<br/>
    /// </param>
    [ChromeProtocol.Core.MethodName("Browser.setContentsSize")]
    public record SetContentsSizeRequest(
      ...
      [property: System.Text.Json.Serialization.JsonPropertyName("height")]
      int? Height = default
    ) : ChromeProtocol.Core.ICommand<SetContentsSizeRequestResult>
    {
    }
    public record SetContentsSizeRequestResult() : ChromeProtocol.Core.IType
    {
    }
    ...
    public static Enyim.Iris.Protocol.Browser.SetDockTileRequest SetDockTile(string? BadgeLabel = default, string? Image = default)    
    {
      return new Enyim.Iris.Protocol.Browser.SetDockTileRequest(BadgeLabel, Image);
    }
    /// <summary>Set dock tile details, platform-specific.</summary>
    /// <param name="Image">Png encoded image. (Encoded as a base64 string when passed over JSON)</param>
    ...
    public static Enyim.Iris.Protocol.Browser.ExecuteBrowserCommandRequest ExecuteBrowserCommand(Enyim.Iris.Protocol.Browser.BrowserCommandIdType CommandId)    
    {
      return new Enyim.Iris.Protocol.Browser.ExecuteBrowserCommandRequest(CommandId);
    }
    /// <summary>Invoke custom browser commands used by telemetry.</summary>
    ...
    public record ExecuteBrowserCommandRequest(
      ...
      Enyim.Iris.Protocol.Browser.BrowserCommandIdType CommandId
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Browser.AddPrivacySandboxEnrollmentOverrideRequest AddPrivacySandboxEnrollmentOverride(string Url)    
    {
      return new Enyim.Iris.Protocol.Browser.AddPrivacySandboxEnrollmentOverrideRequest(Url);
    }
    /// <summary>
    /// Allows a site to use privacy sandbox features that require enrollment<br/>
    /// without the site actually being enrolled. Only supported on page targets.<br/>
    ...
    /// configuration for the origin may exist.<br/>
    /// </summary>
    /// <param name="BrowserContextId">
    /// BrowserContext to perform the action in. When omitted, default browser<br/>
    /// context is used.<br/>
    /// </param>
    public static Enyim.Iris.Protocol.Browser.AddPrivacySandboxCoordinatorKeyConfigRequest AddPrivacySandboxCoordinatorKeyConfig(Enyim.Iris.Protocol.Browser.PrivacySandboxAPIType Api, string CoordinatorOrigin, string KeyConfig, Enyim.Iris.Protocol.Browser.BrowserContextIDType? BrowserContextId = default)    
    {
      return new Enyim.Iris.Protocol.Browser.AddPrivacySandboxCoordinatorKeyConfigRequest(Api, CoordinatorOrigin, KeyConfig, BrowserContextId);
    }
    /// <summary>
    /// Configures encryption keys used with a given privacy sandbox API to talk<br/>
    /// to a trusted coordinator.  Since this is intended for test automation only,<br/>
    ...
    /// context is used.<br/>
    /// </param>
    [ChromeProtocol.Core.MethodName("Browser.addPrivacySandboxCoordinatorKeyConfig")]
    public record AddPrivacySandboxCoordinatorKeyConfigRequest(
      [property: System.Text.Json.Serialization.JsonPropertyName("api")]
      Enyim.Iris.Protocol.Browser.PrivacySandboxAPIType Api,
      [property: System.Text.Json.Serialization.JsonPropertyName("coordinatorOrigin")]
      string CoordinatorOrigin,
      [property: System.Text.Json.Serialization.JsonPropertyName("keyConfig")]
      string KeyConfig,
      [property: System.Text.Json.Serialization.JsonPropertyName("browserContextId")]
      Enyim.Iris.Protocol.Browser.BrowserContextIDType? BrowserContextId = default
    ) : ChromeProtocol.Core.ICommand<AddPrivacySandboxCoordinatorKeyConfigRequestResult>
    {
    }
    public record AddPrivacySandboxCoordinatorKeyConfigRequestResult() : ChromeProtocol.Core.IType
    {
    }
  }
}
