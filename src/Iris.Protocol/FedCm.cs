...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class FedCm
  {
    ...
    public record AccountType(
      ...
      Enyim.Iris.Protocol.FedCm.LoginStateType LoginState,
    ...
    public record DialogShown(
      ...
      Enyim.Iris.Protocol.FedCm.DialogTypeType DialogType,
      [property: System.Text.Json.Serialization.JsonPropertyName("accounts")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.FedCm.AccountType> Accounts,
    ...
    /// </param>
    public static Enyim.Iris.Protocol.FedCm.EnableRequest Enable(bool? DisableRejectionDelay = default)    
    {
      return new Enyim.Iris.Protocol.FedCm.EnableRequest(DisableRejectionDelay);
    }
    /// <param name="DisableRejectionDelay">
    /// Allows callers to disable the promise rejection delay that would<br/>
    /// normally happen, if this is unimportant to what&#39;s being tested.<br/>
    ...
    public static Enyim.Iris.Protocol.FedCm.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.FedCm.DisableRequest();
    }
    ...
    public static Enyim.Iris.Protocol.FedCm.SelectAccountRequest SelectAccount(string DialogId, int AccountIndex)    
    {
      return new Enyim.Iris.Protocol.FedCm.SelectAccountRequest(DialogId, AccountIndex);
    }
    ...
    public static Enyim.Iris.Protocol.FedCm.ClickDialogButtonRequest ClickDialogButton(string DialogId, Enyim.Iris.Protocol.FedCm.DialogButtonType DialogButton)    
    {
      return new Enyim.Iris.Protocol.FedCm.ClickDialogButtonRequest(DialogId, DialogButton);
    }
    ...
    public record ClickDialogButtonRequest(
      ...
      Enyim.Iris.Protocol.FedCm.DialogButtonType DialogButton
    ...
    public static Enyim.Iris.Protocol.FedCm.OpenUrlRequest OpenUrl(string DialogId, int AccountIndex, Enyim.Iris.Protocol.FedCm.AccountUrlTypeType AccountUrlType)    
    {
      return new Enyim.Iris.Protocol.FedCm.OpenUrlRequest(DialogId, AccountIndex, AccountUrlType);
    }
    ...
    public record OpenUrlRequest(
      ...
      Enyim.Iris.Protocol.FedCm.AccountUrlTypeType AccountUrlType
    ...
    public static Enyim.Iris.Protocol.FedCm.DismissDialogRequest DismissDialog(string DialogId, bool? TriggerCooldown = default)    
    {
      return new Enyim.Iris.Protocol.FedCm.DismissDialogRequest(DialogId, TriggerCooldown);
    }
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.FedCm.ResetCooldownRequest ResetCooldown()    
    {
      return new Enyim.Iris.Protocol.FedCm.ResetCooldownRequest();
    }
    /// <summary>
    /// Resets the cooldown time, if any, to allow the next FedCM call to show<br/>
    /// a dialog even if one was recently dismissed by the user.<br/>
