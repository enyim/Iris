...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class Fetch
  {
    ...
    public record RequestPatternType(
      ...
      Enyim.Iris.Protocol.Fetch.RequestStageType? RequestStage = default
    ...
    public record RequestPaused(
      ...
      Enyim.Iris.Protocol.Fetch.RequestIdType RequestId,
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Fetch.HeaderEntryType>? ResponseHeaders = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("networkId")]
      Enyim.Iris.Protocol.Network.RequestIdType? NetworkId = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("redirectedRequestId")]
      Enyim.Iris.Protocol.Fetch.RequestIdType? RedirectedRequestId = default
    ...
    public record AuthRequired(
      ...
      Enyim.Iris.Protocol.Fetch.AuthChallengeType AuthChallenge
    ) : ChromeProtocol.Core.IEvent
    {
    }
    /// <summary>Disables the fetch domain.</summary>
    public static Enyim.Iris.Protocol.Fetch.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Fetch.DisableRequest();
    }
    /// <summary>Disables the fetch domain.</summary>
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Fetch.EnableRequest Enable(System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Fetch.RequestPatternType>? Patterns = default, bool? HandleAuthRequests = default)    
    {
      return new Enyim.Iris.Protocol.Fetch.EnableRequest(Patterns, HandleAuthRequests);
    }
    /// <summary>
    /// Enables issuing of requestPaused events. A request will be paused until client<br/>
    /// calls one of failRequest, fulfillRequest or continueRequest/continueWithAuth.<br/>
    ...
    public record EnableRequest(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Fetch.RequestPatternType>? Patterns = default,
    ...
    public static Enyim.Iris.Protocol.Fetch.FailRequestRequest FailRequest(Enyim.Iris.Protocol.Fetch.RequestIdType RequestId, Enyim.Iris.Protocol.Network.ErrorReasonType ErrorReason)    
    {
      return new Enyim.Iris.Protocol.Fetch.FailRequestRequest(RequestId, ErrorReason);
    }
    /// <summary>Causes the request to fail with specified reason.</summary>
    /// <param name="RequestId">An id the client received in requestPaused event.</param>
    /// <param name="ErrorReason">Causes the request to fail with the given reason.</param>
    ...
    public record FailRequestRequest(
      ...
      Enyim.Iris.Protocol.Network.ErrorReasonType ErrorReason
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Fetch.FulfillRequestRequest FulfillRequest(Enyim.Iris.Protocol.Fetch.RequestIdType RequestId, int ResponseCode, System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Fetch.HeaderEntryType>? ResponseHeaders = default, string? BinaryResponseHeaders = default, string? Body = default, string? ResponsePhrase = default)    
    {
      return new Enyim.Iris.Protocol.Fetch.FulfillRequestRequest(RequestId, ResponseCode, ResponseHeaders, BinaryResponseHeaders, Body, ResponsePhrase);
    }
    /// <summary>Provides response to the request.</summary>
    /// <param name="RequestId">An id the client received in requestPaused event.</param>
    /// <param name="ResponseCode">An HTTP response code.</param>
    ...
    public static Enyim.Iris.Protocol.Fetch.ContinueRequestRequest ContinueRequest(Enyim.Iris.Protocol.Fetch.RequestIdType RequestId, string? Url = default, string? Method = default, string? PostData = default, System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Fetch.HeaderEntryType>? Headers = default, bool? InterceptResponse = default)    
    {
      return new Enyim.Iris.Protocol.Fetch.ContinueRequestRequest(RequestId, Url, Method, PostData, Headers, InterceptResponse);
    }
    /// <summary>Continues the request, optionally modifying some of its parameters.</summary>
    /// <param name="RequestId">An id the client received in requestPaused event.</param>
    /// <param name="Url">If set, the request url will be modified in a way that&#39;s not observable by page.</param>
    ...
    public record ContinueRequestRequest(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Fetch.HeaderEntryType>? Headers = default,
    ...
    public static Enyim.Iris.Protocol.Fetch.ContinueWithAuthRequest ContinueWithAuth(Enyim.Iris.Protocol.Fetch.RequestIdType RequestId, Enyim.Iris.Protocol.Fetch.AuthChallengeResponseType AuthChallengeResponse)    
    {
      return new Enyim.Iris.Protocol.Fetch.ContinueWithAuthRequest(RequestId, AuthChallengeResponse);
    }
    /// <summary>Continues a request supplying authChallengeResponse following authRequired event.</summary>
    /// <param name="RequestId">An id the client received in authRequired event.</param>
    /// <param name="AuthChallengeResponse">Response to  with an authChallenge.</param>
    ...
    public record ContinueWithAuthRequest(
      ...
      Enyim.Iris.Protocol.Fetch.AuthChallengeResponseType AuthChallengeResponse
    ...
    /// over the protocol as text. (Encoded as a base64 string when passed over JSON)<br/>
    /// </param>
    public static Enyim.Iris.Protocol.Fetch.ContinueResponseRequest ContinueResponse(Enyim.Iris.Protocol.Fetch.RequestIdType RequestId, int? ResponseCode = default, string? ResponsePhrase = default, System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Fetch.HeaderEntryType>? ResponseHeaders = default, string? BinaryResponseHeaders = default)    
    {
      return new Enyim.Iris.Protocol.Fetch.ContinueResponseRequest(RequestId, ResponseCode, ResponsePhrase, ResponseHeaders, BinaryResponseHeaders);
    }
    /// <summary>
    /// Continues loading of the paused response, optionally modifying the<br/>
    /// response headers. If either responseCode or headers are modified, all of them<br/>
    ...
    public static Enyim.Iris.Protocol.Fetch.GetResponseBodyRequest GetResponseBody(Enyim.Iris.Protocol.Fetch.RequestIdType RequestId)    
    {
      return new Enyim.Iris.Protocol.Fetch.GetResponseBodyRequest(RequestId);
    }
    /// <summary>
    /// Causes the body of the response to be received from the server and<br/>
    /// returned as a single string. May only be issued for a request that<br/>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Fetch.TakeResponseBodyAsStreamRequest TakeResponseBodyAsStream(Enyim.Iris.Protocol.Fetch.RequestIdType RequestId)    
    {
      return new Enyim.Iris.Protocol.Fetch.TakeResponseBodyAsStreamRequest(RequestId);
    }
    /// <summary>
    /// Returns a handle to the stream representing the response body.<br/>
    /// The request must be paused in the HeadersReceived stage.<br/>
