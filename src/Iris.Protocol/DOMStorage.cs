...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class DOMStorage
  {
    ...
    public record StorageIdType(
      ...
      Enyim.Iris.Protocol.DOMStorage.SerializedStorageKeyType? StorageKey = default
    ...
    public record DomStorageItemAdded(
      ...
      Enyim.Iris.Protocol.DOMStorage.StorageIdType StorageId,
    ...
    public static Enyim.Iris.Protocol.DOMStorage.ClearRequest Clear(Enyim.Iris.Protocol.DOMStorage.StorageIdType StorageId)    
    {
      return new Enyim.Iris.Protocol.DOMStorage.ClearRequest(StorageId);
    }
    ...
    public static Enyim.Iris.Protocol.DOMStorage.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.DOMStorage.DisableRequest();
    }
    /// <summary>Disables storage tracking, prevents storage events from being sent to the client.</summary>
    ...
    public static Enyim.Iris.Protocol.DOMStorage.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.DOMStorage.EnableRequest();
    }
    /// <summary>Enables storage tracking, storage events will now be delivered to the client.</summary>
    ...
    public static Enyim.Iris.Protocol.DOMStorage.GetDOMStorageItemsRequest GetDOMStorageItems(Enyim.Iris.Protocol.DOMStorage.StorageIdType StorageId)    
    {
      return new Enyim.Iris.Protocol.DOMStorage.GetDOMStorageItemsRequest(StorageId);
    }
    ...
    public record GetDOMStorageItemsRequestResult(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.DOMStorage.ItemType> Entries
    ) : ChromeProtocol.Core.IType
    {
    }
    public static Enyim.Iris.Protocol.DOMStorage.RemoveDOMStorageItemRequest RemoveDOMStorageItem(Enyim.Iris.Protocol.DOMStorage.StorageIdType StorageId, string Key)    
    {
      return new Enyim.Iris.Protocol.DOMStorage.RemoveDOMStorageItemRequest(StorageId, Key);
    }
    ...
    public static Enyim.Iris.Protocol.DOMStorage.SetDOMStorageItemRequest SetDOMStorageItem(Enyim.Iris.Protocol.DOMStorage.StorageIdType StorageId, string Key, string Value)    
    {
      return new Enyim.Iris.Protocol.DOMStorage.SetDOMStorageItemRequest(StorageId, Key, Value);
    }
