...
namespace Enyim.Iris.Protocol
{
  public static partial class Performance
  {
    ...
    public record Metrics(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Performance.MetricType> MetricsProperty,
    ...
    public static Enyim.Iris.Protocol.Performance.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Performance.DisableRequest();
    }
    /// <summary>Disable collecting and reporting metrics.</summary>
    ...
    public static Enyim.Iris.Protocol.Performance.EnableRequest Enable(string? TimeDomain = default)    
    {
      return new Enyim.Iris.Protocol.Performance.EnableRequest(TimeDomain);
    }
    /// <summary>Enable collecting and reporting metrics.</summary>
    /// <param name="TimeDomain">Time domain to use for collecting and reporting duration metrics.</param>
    ...
    public static Enyim.Iris.Protocol.Performance.SetTimeDomainRequest SetTimeDomain(string TimeDomain)    
    {
      return new Enyim.Iris.Protocol.Performance.SetTimeDomainRequest(TimeDomain);
    }
    /// <summary>
    /// Sets time domain to use for collecting and reporting duration metrics.<br/>
    /// Note that this must be called before enabling metrics collection. Calling<br/>
    ...
    public static Enyim.Iris.Protocol.Performance.GetMetricsRequest GetMetrics()    
    {
      return new Enyim.Iris.Protocol.Performance.GetMetricsRequest();
    }
    /// <summary>Retrieve current values of run-time metrics.</summary>
    ...
    public record GetMetricsRequestResult(
      [property: System.Text.Json.Serialization.JsonPropertyName("metrics")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Performance.MetricType> Metrics
    ) : ChromeProtocol.Core.IType
    {
    }
  }
