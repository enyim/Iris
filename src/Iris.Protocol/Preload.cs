...
namespace Enyim.Iris.Protocol
{
  public static partial class Preload
  {
    ...
    /// https://github.com/WICG/nav-speculation/blob/main/speculation-rules-tags.md<br/>
    /// </param>
    public record RuleSetType(
      [property: System.Text.Json.Serialization.JsonPropertyName("id")]
      Enyim.Iris.Protocol.Preload.RuleSetIdType Id,
      ...
      Enyim.Iris.Protocol.Preload.RuleSetErrorTypeType? ErrorType = default,
    ...
    public record PreloadingAttemptKeyType(
      ...
      Enyim.Iris.Protocol.Preload.SpeculationActionType Action,
      [property: System.Text.Json.Serialization.JsonPropertyName("url")]
      string Url,
      [property: System.Text.Json.Serialization.JsonPropertyName("formSubmission")]
      bool? FormSubmission = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("targetHint")]
      Enyim.Iris.Protocol.Preload.SpeculationTargetHintType? TargetHint = default
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>
    ...
    public record PreloadingAttemptSourceType(
      ...
      Enyim.Iris.Protocol.Preload.PreloadingAttemptKeyType Key,
      [property: System.Text.Json.Serialization.JsonPropertyName("ruleSetIds")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Preload.RuleSetIdType> RuleSetIds,
      [property: System.Text.Json.Serialization.JsonPropertyName("nodeIds")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.DOM.BackendNodeIdType> NodeIds
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>
    ...
    /// `PreloadPipelineId`.<br/>
    /// </summary>
    [System.Text.Json.Serialization.JsonConverter(typeof(ChromeProtocol.Core.PrimitiveTypeConverter))]
    public record PreloadPipelineIdType(
      string Value
    ) : ChromeProtocol.Core.PrimitiveType<string>(Value)
    {
    }
    ...
    public record RuleSetUpdated(
      ...
      Enyim.Iris.Protocol.Preload.RuleSetType RuleSet
    ...
    public record PrefetchStatusUpdated(
      [property: System.Text.Json.Serialization.JsonPropertyName("key")]
      Enyim.Iris.Protocol.Preload.PreloadingAttemptKeyType Key,
      [property: System.Text.Json.Serialization.JsonPropertyName("pipelineId")]
      Enyim.Iris.Protocol.Preload.PreloadPipelineIdType PipelineId,
      [property: System.Text.Json.Serialization.JsonPropertyName("initiatingFrameId")]
      Enyim.Iris.Protocol.Page.FrameIdType InitiatingFrameId,
      ...
      Enyim.Iris.Protocol.Preload.PreloadingStatusType Status,
      [property: System.Text.Json.Serialization.JsonPropertyName("prefetchStatus")]
      Enyim.Iris.Protocol.Preload.PrefetchStatusType PrefetchStatus,
      [property: System.Text.Json.Serialization.JsonPropertyName("requestId")]
    ...
    public record PrerenderStatusUpdated(
      ...
      Enyim.Iris.Protocol.Preload.PrerenderFinalStatusType? PrerenderStatus = default,
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Preload.PrerenderMismatchedHeadersType>? MismatchedHeaders = default
    ) : ChromeProtocol.Core.IEvent
    {
    }
    ...
    public record PreloadingAttemptSourcesUpdated(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Preload.PreloadingAttemptSourceType> PreloadingAttemptSources
    ) : ChromeProtocol.Core.IEvent
    {
    }
    public static Enyim.Iris.Protocol.Preload.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.Preload.EnableRequest();
    }
    ...
    public static Enyim.Iris.Protocol.Preload.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Preload.DisableRequest();
    }
