...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class Log
  {
    ...
    public record LogEntryType(
      ...
      Enyim.Iris.Protocol.Network.RequestIdType? NetworkRequestId = default,
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Runtime.RemoteObjectType>? Args = default
    ...
    public record EntryAdded(
      ...
      Enyim.Iris.Protocol.Log.LogEntryType Entry
    ) : ChromeProtocol.Core.IEvent
    {
    }
    /// <summary>Clears the log.</summary>
    public static Enyim.Iris.Protocol.Log.ClearRequest Clear()    
    {
      return new Enyim.Iris.Protocol.Log.ClearRequest();
    }
    /// <summary>Clears the log.</summary>
    ...
    public static Enyim.Iris.Protocol.Log.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Log.DisableRequest();
    }
    /// <summary>Disables log domain, prevents further log entries from being reported to the client.</summary>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Log.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.Log.EnableRequest();
    }
    /// <summary>
    /// Enables log domain, sends the entries collected so far to the client by means of the<br/>
    /// `entryAdded` notification.<br/>
    ...
    public static Enyim.Iris.Protocol.Log.StartViolationsReportRequest StartViolationsReport(System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Log.ViolationSettingType> Config)    
    {
      return new Enyim.Iris.Protocol.Log.StartViolationsReportRequest(Config);
    }
    /// <summary>start violation reporting.</summary>
    /// <param name="Config">Configuration for violations.</param>
    ...
    public record StartViolationsReportRequest(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Log.ViolationSettingType> Config
    ...
    public static Enyim.Iris.Protocol.Log.StopViolationsReportRequest StopViolationsReport()    
    {
      return new Enyim.Iris.Protocol.Log.StopViolationsReportRequest();
    }
    /// <summary>Stop violation reporting.</summary>
