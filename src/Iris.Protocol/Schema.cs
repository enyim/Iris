...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class Schema
  {
    ...
    public static Enyim.Iris.Protocol.Schema.GetDomainsRequest GetDomains()    
    {
      return new Enyim.Iris.Protocol.Schema.GetDomainsRequest();
    }
    /// <summary>Returns supported domains.</summary>
    ...
    public record GetDomainsRequestResult(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Schema.DomainType> Domains
    ) : ChromeProtocol.Core.IType
    {
    }
  }
