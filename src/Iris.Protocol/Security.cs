...
namespace Enyim.Iris.Protocol
{
  public static partial class Security
  {
    ...
    public record SafetyTipInfoType(
      ...
      Enyim.Iris.Protocol.Security.SafetyTipStatusType SafetyTipStatus,
    ...
    public record VisibleSecurityStateType(
      ...
      Enyim.Iris.Protocol.Security.CertificateSecurityStateType? CertificateSecurityState = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("safetyTipInfo")]
      Enyim.Iris.Protocol.Security.SafetyTipInfoType? SafetyTipInfo = default
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record SecurityStateExplanationType(
      ...
      Enyim.Iris.Protocol.Security.MixedContentTypeType MixedContentType,
      [property: System.Text.Json.Serialization.JsonPropertyName("certificate")]
      System.Collections.Generic.IReadOnlyList<string> Certificate,
    ...
    public record InsecureContentStatusType(
      ...
      Enyim.Iris.Protocol.Security.SecurityStateType RanInsecureContentStyle,
      [property: System.Text.Json.Serialization.JsonPropertyName("displayedInsecureContentStyle")]
      Enyim.Iris.Protocol.Security.SecurityStateType DisplayedInsecureContentStyle
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>
    ...
    public record VisibleSecurityStateChanged(
      ...
      Enyim.Iris.Protocol.Security.VisibleSecurityStateType VisibleSecurityState
    ) : ChromeProtocol.Core.IEvent
    {
    }
    ...
    public record SecurityStateChanged(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Security.SecurityStateExplanationType> Explanations,
      [property: System.Obsolete("This property marked as deprecated in the corresponding CDP definition schema. It may be removed in the future releases.", false)]
      [property: System.Text.Json.Serialization.JsonPropertyName("insecureContentStatus")]
      Enyim.Iris.Protocol.Security.InsecureContentStatusType InsecureContentStatus,
      [property: System.Obsolete("This property marked as deprecated in the corresponding CDP definition schema. It may be removed in the future releases.", false)]
      [property: System.Text.Json.Serialization.JsonPropertyName("summary")]
    ...
    public static Enyim.Iris.Protocol.Security.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Security.DisableRequest();
    }
    /// <summary>Disables tracking security state changes.</summary>
    ...
    public static Enyim.Iris.Protocol.Security.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.Security.EnableRequest();
    }
    /// <summary>Enables tracking security state changes.</summary>
    ...
    public static Enyim.Iris.Protocol.Security.SetIgnoreCertificateErrorsRequest SetIgnoreCertificateErrors(bool Ignore)    
    {
      return new Enyim.Iris.Protocol.Security.SetIgnoreCertificateErrorsRequest(Ignore);
    }
    /// <summary>Enable/disable whether all certificate errors should be ignored.</summary>
    /// <param name="Ignore">If true, all certificate errors will be ignored.</param>
    ...
    public static Enyim.Iris.Protocol.Security.HandleCertificateErrorRequest HandleCertificateError(int EventId, Enyim.Iris.Protocol.Security.CertificateErrorActionType Action)    
    {
      return new Enyim.Iris.Protocol.Security.HandleCertificateErrorRequest(EventId, Action);
    }
    /// <summary>Handles a certificate error that fired a certificateError event.</summary>
    /// <param name="EventId">The ID of the event.</param>
    /// <param name="Action">The action to take on the certificate error.</param>
    ...
    public record HandleCertificateErrorRequest(
      ...
      Enyim.Iris.Protocol.Security.CertificateErrorActionType Action
    ...
    [System.Obsolete("This command marked as deprecated in the corresponding CDP definition schema. It may be removed in the future releases.", false)]
    public static Enyim.Iris.Protocol.Security.SetOverrideCertificateErrorsRequest SetOverrideCertificateErrors(bool Override)    
    {
      return new Enyim.Iris.Protocol.Security.SetOverrideCertificateErrorsRequest(Override);
    }
    /// <summary>
    /// Enable/disable overriding certificate errors. If enabled, all certificate error events need to<br/>
    /// be handled by the DevTools client and should be answered with `handleCertificateError` commands.<br/>
