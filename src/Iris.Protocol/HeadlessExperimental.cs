...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class HeadlessExperimental
  {
    ...
    /// </param>
    public static Enyim.Iris.Protocol.HeadlessExperimental.BeginFrameRequest BeginFrame(double? FrameTimeTicks = default, double? Interval = default, bool? NoDisplayUpdates = default, Enyim.Iris.Protocol.HeadlessExperimental.ScreenshotParamsType? Screenshot = default)    
    {
      return new Enyim.Iris.Protocol.HeadlessExperimental.BeginFrameRequest(FrameTimeTicks, Interval, NoDisplayUpdates, Screenshot);
    }
    /// <summary>
    /// Sends a BeginFrame to the target and returns when the frame was completed. Optionally captures a<br/>
    /// screenshot from the resulting frame. Requires that the target was created with enabled<br/>
    ...
    public record BeginFrameRequest(
      ...
      Enyim.Iris.Protocol.HeadlessExperimental.ScreenshotParamsType? Screenshot = default
    ...
    public static Enyim.Iris.Protocol.HeadlessExperimental.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.HeadlessExperimental.DisableRequest();
    }
    /// <summary>Disables headless events for the target.</summary>
    ...
    [System.Obsolete("This command marked as deprecated in the corresponding CDP definition schema. It may be removed in the future releases.", false)]
    public static Enyim.Iris.Protocol.HeadlessExperimental.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.HeadlessExperimental.EnableRequest();
    }
    /// <summary>Enables headless events for the target.</summary>
