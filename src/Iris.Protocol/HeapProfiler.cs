...
namespace Enyim.Iris.Protocol
{
  public static partial class HeapProfiler
  {
    ...
    public record SamplingHeapProfileNodeType(
      ...
      Enyim.Iris.Protocol.Runtime.CallFrameType CallFrame,
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.HeapProfiler.SamplingHeapProfileNodeType> Children
    ...
    public record SamplingHeapProfileType(
      ...
      Enyim.Iris.Protocol.HeapProfiler.SamplingHeapProfileNodeType Head,
      [property: System.Text.Json.Serialization.JsonPropertyName("samples")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.HeapProfiler.SamplingHeapProfileSampleType> Samples
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public static Enyim.Iris.Protocol.HeapProfiler.AddInspectedHeapObjectRequest AddInspectedHeapObject(Enyim.Iris.Protocol.HeapProfiler.HeapSnapshotObjectIdType HeapObjectId)    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.AddInspectedHeapObjectRequest(HeapObjectId);
    }
    /// <summary>
    /// Enables console to refer to the node with given id via $x (see Command Line API for more details<br/>
    /// $x functions).<br/>
    ...
    public record AddInspectedHeapObjectRequest(
      ...
      Enyim.Iris.Protocol.HeapProfiler.HeapSnapshotObjectIdType HeapObjectId
    ...
    public static Enyim.Iris.Protocol.HeapProfiler.CollectGarbageRequest CollectGarbage()    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.CollectGarbageRequest();
    }
    ...
    public static Enyim.Iris.Protocol.HeapProfiler.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.DisableRequest();
    }
    ...
    public static Enyim.Iris.Protocol.HeapProfiler.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.EnableRequest();
    }
    ...
    public static Enyim.Iris.Protocol.HeapProfiler.GetHeapObjectIdRequest GetHeapObjectId(Enyim.Iris.Protocol.Runtime.RemoteObjectIdType ObjectId)    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.GetHeapObjectIdRequest(ObjectId);
    }
    /// <param name="ObjectId">Identifier of the object to get heap object id for.</param>
    ...
    public record GetHeapObjectIdRequestResult(
      ...
      Enyim.Iris.Protocol.HeapProfiler.HeapSnapshotObjectIdType HeapSnapshotObjectId
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <param name="ObjectGroup">Symbolic group name that can be used to release multiple objects.</param>
    public static Enyim.Iris.Protocol.HeapProfiler.GetObjectByHeapObjectIdRequest GetObjectByHeapObjectId(Enyim.Iris.Protocol.HeapProfiler.HeapSnapshotObjectIdType ObjectId, string? ObjectGroup = default)    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.GetObjectByHeapObjectIdRequest(ObjectId, ObjectGroup);
    }
    /// <param name="ObjectGroup">Symbolic group name that can be used to release multiple objects.</param>
    [ChromeProtocol.Core.MethodName("HeapProfiler.getObjectByHeapObjectId")]
    public record GetObjectByHeapObjectIdRequest(
      [property: System.Text.Json.Serialization.JsonPropertyName("objectId")]
      Enyim.Iris.Protocol.HeapProfiler.HeapSnapshotObjectIdType ObjectId,
    ...
    public static Enyim.Iris.Protocol.HeapProfiler.GetSamplingProfileRequest GetSamplingProfile()    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.GetSamplingProfileRequest();
    }
    ...
    public record GetSamplingProfileRequestResult(
      ...
      Enyim.Iris.Protocol.HeapProfiler.SamplingHeapProfileType Profile
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    /// </param>
    public static Enyim.Iris.Protocol.HeapProfiler.StartSamplingRequest StartSampling(double? SamplingInterval = default, double? StackDepth = default, bool? IncludeObjectsCollectedByMajorGC = default, bool? IncludeObjectsCollectedByMinorGC = default)    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.StartSamplingRequest(SamplingInterval, StackDepth, IncludeObjectsCollectedByMajorGC, IncludeObjectsCollectedByMinorGC);
    }
    /// <param name="SamplingInterval">
    /// Average sample interval in bytes. Poisson distribution is used for the intervals. The<br/>
    /// default value is 32768 bytes.<br/>
    ...
    public record StartSamplingRequest(
      ...
      [property: System.Text.Json.Serialization.JsonPropertyName("stackDepth")]
    ...
    public static Enyim.Iris.Protocol.HeapProfiler.StartTrackingHeapObjectsRequest StartTrackingHeapObjects(bool? TrackAllocations = default)    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.StartTrackingHeapObjectsRequest(TrackAllocations);
    }
    ...
    public static Enyim.Iris.Protocol.HeapProfiler.StopSamplingRequest StopSampling()    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.StopSamplingRequest();
    }
    ...
    public static Enyim.Iris.Protocol.HeapProfiler.StopTrackingHeapObjectsRequest StopTrackingHeapObjects(bool? ReportProgress = default, bool? TreatGlobalObjectsAsRoots = default, bool? CaptureNumericValue = default, bool? ExposeInternals = default)    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.StopTrackingHeapObjectsRequest(ReportProgress, TreatGlobalObjectsAsRoots, CaptureNumericValue, ExposeInternals);
    }
    /// <param name="ReportProgress">
    /// If true &#39;reportHeapSnapshotProgress&#39; events will be generated while snapshot is being taken<br/>
    /// when the tracking is stopped.<br/>
    ...
    /// <param name="CaptureNumericValue">If true, numerical values are included in the snapshot</param>
    /// <param name="ExposeInternals">If true, exposes internals of the snapshot.</param>
    public static Enyim.Iris.Protocol.HeapProfiler.TakeHeapSnapshotRequest TakeHeapSnapshot(bool? ReportProgress = default, bool? TreatGlobalObjectsAsRoots = default, bool? CaptureNumericValue = default, bool? ExposeInternals = default)    
    {
      return new Enyim.Iris.Protocol.HeapProfiler.TakeHeapSnapshotRequest(ReportProgress, TreatGlobalObjectsAsRoots, CaptureNumericValue, ExposeInternals);
    }
    /// <param name="ReportProgress">If true &#39;reportHeapSnapshotProgress&#39; events will be generated while snapshot is being taken.</param>
    /// <param name="TreatGlobalObjectsAsRoots">
    /// If true, a raw snapshot without artificial roots will be generated.<br/>
