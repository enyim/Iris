...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class Debugger
  {
    ...
    public record LocationRangeType(
      ...
      Enyim.Iris.Protocol.Debugger.ScriptPositionType Start,
      [property: System.Text.Json.Serialization.JsonPropertyName("end")]
      Enyim.Iris.Protocol.Debugger.ScriptPositionType End
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record CallFrameType(
      ...
      Enyim.Iris.Protocol.Debugger.CallFrameIdType CallFrameId,
      ...
      Enyim.Iris.Protocol.Debugger.LocationType Location,
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.ScopeType> ScopeChain,
      [property: System.Text.Json.Serialization.JsonPropertyName("this")]
      Enyim.Iris.Protocol.Runtime.RemoteObjectType This,
      [property: System.Text.Json.Serialization.JsonPropertyName("functionLocation")]
      Enyim.Iris.Protocol.Debugger.LocationType? FunctionLocation = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("returnValue")]
      Enyim.Iris.Protocol.Runtime.RemoteObjectType? ReturnValue = default,
    ...
    public record ScopeType(
      ...
      Enyim.Iris.Protocol.Debugger.LocationType? StartLocation = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("endLocation")]
      Enyim.Iris.Protocol.Debugger.LocationType? EndLocation = default
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record ResolvedBreakpointType(
      [property: System.Text.Json.Serialization.JsonPropertyName("breakpointId")]
      Enyim.Iris.Protocol.Debugger.BreakpointIdType BreakpointId,
      [property: System.Text.Json.Serialization.JsonPropertyName("location")]
      Enyim.Iris.Protocol.Debugger.LocationType Location
    ) : ChromeProtocol.Core.IType
    {
    ...
    /// Deprecated in favor of `resolvedBreakpoints` in the `scriptParsed` event.<br/>
    /// </summary>
    /// <param name="BreakpointId">Breakpoint unique identifier.</param>
    /// <param name="Location">Actual breakpoint location.</param>
    ...
    public record Paused(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.CallFrameType> CallFrames,
      ...
      Enyim.Iris.Protocol.Runtime.StackTraceType? AsyncStackTrace = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("asyncStackTraceId")]
      Enyim.Iris.Protocol.Runtime.StackTraceIdType? AsyncStackTraceId = default,
      [property: System.Obsolete("This property marked as deprecated in the corresponding CDP definition schema. It may be removed in the future releases.", false)]
      [property: System.Text.Json.Serialization.JsonPropertyName("asyncCallStackTraceId")]
      Enyim.Iris.Protocol.Runtime.StackTraceIdType? AsyncCallStackTraceId = default
    ) : ChromeProtocol.Core.IEvent
    {
    }
    ...
    public record ScriptFailedToParse(
      ...
      string Hash,
      [property: System.Text.Json.Serialization.JsonPropertyName("buildId")]
      string BuildId,
      ...
      Enyim.Iris.Protocol.Debugger.ScriptLanguageType? ScriptLanguage = default,
    ...
    /// The list of set breakpoints in this script if calls to `setBreakpointByUrl`<br/>
    /// matches this script&#39;s URL or hash. Clients that use this list can ignore the<br/>
    /// `breakpointResolved` event. They are equivalent.<br/>
    /// </param>
    ...
    public record ScriptParsed(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.DebugSymbolsType>? DebugSymbols = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("embedderName")]
      string? EmbedderName = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("resolvedBreakpoints")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.ResolvedBreakpointType>? ResolvedBreakpoints = default
    ) : ChromeProtocol.Core.IEvent
    {
    }
    /// <summary>Continues execution until specific location is reached.</summary>
    /// <param name="Location">Location to continue to.</param>
    public static Enyim.Iris.Protocol.Debugger.ContinueToLocationRequest ContinueToLocation(Enyim.Iris.Protocol.Debugger.LocationType Location, string? TargetCallFrames = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.ContinueToLocationRequest(Location, TargetCallFrames);
    }
    /// <summary>Continues execution until specific location is reached.</summary>
    /// <param name="Location">Location to continue to.</param>
    ...
    public static Enyim.Iris.Protocol.Debugger.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Debugger.DisableRequest();
    }
    /// <summary>Disables debugger for given page.</summary>
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Debugger.EnableRequest Enable(double? MaxScriptsCacheSize = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.EnableRequest(MaxScriptsCacheSize);
    }
    /// <summary>
    /// Enables debugger for the given page. Clients should not assume that the debugging has been<br/>
    /// enabled until the result for this command is received.<br/>
    ...
    public static Enyim.Iris.Protocol.Debugger.EvaluateOnCallFrameRequest EvaluateOnCallFrame(Enyim.Iris.Protocol.Debugger.CallFrameIdType CallFrameId, string Expression, string? ObjectGroup = default, bool? IncludeCommandLineAPI = default, bool? Silent = default, bool? ReturnByValue = default, bool? GeneratePreview = default, bool? ThrowOnSideEffect = default, Enyim.Iris.Protocol.Runtime.TimeDeltaType? Timeout = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.EvaluateOnCallFrameRequest(CallFrameId, Expression, ObjectGroup, IncludeCommandLineAPI, Silent, ReturnByValue, GeneratePreview, ThrowOnSideEffect, Timeout);
    }
    /// <summary>Evaluates expression on a given call frame.</summary>
    /// <param name="CallFrameId">Call frame identifier to evaluate on.</param>
    /// <param name="Expression">Expression to evaluate.</param>
    ...
    public static Enyim.Iris.Protocol.Debugger.GetPossibleBreakpointsRequest GetPossibleBreakpoints(Enyim.Iris.Protocol.Debugger.LocationType Start, Enyim.Iris.Protocol.Debugger.LocationType? End = default, bool? RestrictToFunction = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.GetPossibleBreakpointsRequest(Start, End, RestrictToFunction);
    }
    /// <summary>
    /// Returns possible locations for breakpoint. scriptId in start and end range locations should be<br/>
    /// the same.<br/>
    ...
    public record GetPossibleBreakpointsRequest(
      [property: System.Text.Json.Serialization.JsonPropertyName("start")]
      Enyim.Iris.Protocol.Debugger.LocationType Start,
      [property: System.Text.Json.Serialization.JsonPropertyName("end")]
      Enyim.Iris.Protocol.Debugger.LocationType? End = default,
    ...
    public record GetPossibleBreakpointsRequestResult(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.BreakLocationType> Locations
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>Returns source for the script with given id.</summary>
    /// <param name="ScriptId">Id of the script to get source for.</param>
    public static Enyim.Iris.Protocol.Debugger.GetScriptSourceRequest GetScriptSource(Enyim.Iris.Protocol.Runtime.ScriptIdType ScriptId)    
    {
      return new Enyim.Iris.Protocol.Debugger.GetScriptSourceRequest(ScriptId);
    }
    /// <summary>Returns source for the script with given id.</summary>
    /// <param name="ScriptId">Id of the script to get source for.</param>
    ...
    public static Enyim.Iris.Protocol.Debugger.DisassembleWasmModuleRequest DisassembleWasmModule(Enyim.Iris.Protocol.Runtime.ScriptIdType ScriptId)    
    {
      return new Enyim.Iris.Protocol.Debugger.DisassembleWasmModuleRequest(ScriptId);
    }
    /// <param name="ScriptId">Id of the script to disassemble</param>
    ...
    public record DisassembleWasmModuleRequestResult(
      ...
      Enyim.Iris.Protocol.Debugger.WasmDisassemblyChunkType Chunk,
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Debugger.NextWasmDisassemblyChunkRequest NextWasmDisassemblyChunk(string StreamId)    
    {
      return new Enyim.Iris.Protocol.Debugger.NextWasmDisassemblyChunkRequest(StreamId);
    }
    /// <summary>
    /// Disassemble the next chunk of lines for the module corresponding to the<br/>
    /// stream. If disassembly is complete, this API will invalidate the streamId<br/>
    ...
    public static Enyim.Iris.Protocol.Debugger.GetWasmBytecodeRequest GetWasmBytecode(Enyim.Iris.Protocol.Runtime.ScriptIdType ScriptId)    
    {
      return new Enyim.Iris.Protocol.Debugger.GetWasmBytecodeRequest(ScriptId);
    }
    /// <summary>This command is deprecated. Use getScriptSource instead.</summary>
    /// <param name="ScriptId">Id of the Wasm script to get source for.</param>
    ...
    public static Enyim.Iris.Protocol.Debugger.GetStackTraceRequest GetStackTrace(Enyim.Iris.Protocol.Runtime.StackTraceIdType StackTraceId)    
    {
      return new Enyim.Iris.Protocol.Debugger.GetStackTraceRequest(StackTraceId);
    }
    /// <summary>Returns stack trace with given `stackTraceId`.</summary>
    ...
    public record GetStackTraceRequest(
      ...
      Enyim.Iris.Protocol.Runtime.StackTraceIdType StackTraceId
    ) : ChromeProtocol.Core.ICommand<GetStackTraceRequestResult>
    {
    }
    public record GetStackTraceRequestResult(
      [property: System.Text.Json.Serialization.JsonPropertyName("stackTrace")]
      Enyim.Iris.Protocol.Runtime.StackTraceType StackTrace
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>Stops on the next JavaScript statement.</summary>
    public static Enyim.Iris.Protocol.Debugger.PauseRequest Pause()    
    {
      return new Enyim.Iris.Protocol.Debugger.PauseRequest();
    }
    /// <summary>Stops on the next JavaScript statement.</summary>
    ...
    [System.Obsolete("This command marked as deprecated in the corresponding CDP definition schema. It may be removed in the future releases.", false)]
    public static Enyim.Iris.Protocol.Debugger.PauseOnAsyncCallRequest PauseOnAsyncCall(Enyim.Iris.Protocol.Runtime.StackTraceIdType ParentStackTraceId)    
    {
      return new Enyim.Iris.Protocol.Debugger.PauseOnAsyncCallRequest(ParentStackTraceId);
    }
    /// <param name="ParentStackTraceId">Debugger will pause when async call with given stack trace is started.</param>
    ...
    public record PauseOnAsyncCallRequest(
      ...
      Enyim.Iris.Protocol.Runtime.StackTraceIdType ParentStackTraceId
    ...
    public static Enyim.Iris.Protocol.Debugger.RemoveBreakpointRequest RemoveBreakpoint(Enyim.Iris.Protocol.Debugger.BreakpointIdType BreakpointId)    
    {
      return new Enyim.Iris.Protocol.Debugger.RemoveBreakpointRequest(BreakpointId);
    }
    /// <summary>Removes JavaScript breakpoint.</summary>
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Debugger.RestartFrameRequest RestartFrame(Enyim.Iris.Protocol.Debugger.CallFrameIdType CallFrameId, string? Mode = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.RestartFrameRequest(CallFrameId, Mode);
    }
    /// <summary>
    /// Restarts particular call frame from the beginning. The old, deprecated<br/>
    /// behavior of `restartFrame` is to stay paused and allow further CDP commands<br/>
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Debugger.ResumeRequest Resume(bool? TerminateOnResume = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.ResumeRequest(TerminateOnResume);
    }
    /// <summary>Resumes JavaScript execution.</summary>
    /// <param name="TerminateOnResume">
    /// Set to true to terminate execution upon resuming execution. In contrast<br/>
    ...
    public static Enyim.Iris.Protocol.Debugger.SearchInContentRequest SearchInContent(Enyim.Iris.Protocol.Runtime.ScriptIdType ScriptId, string Query, bool? CaseSensitive = default, bool? IsRegex = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.SearchInContentRequest(ScriptId, Query, CaseSensitive, IsRegex);
    }
    /// <summary>Searches for given string in script content.</summary>
    /// <param name="ScriptId">Id of the script to search in.</param>
    /// <param name="Query">String to search for.</param>
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Debugger.SetAsyncCallStackDepthRequest SetAsyncCallStackDepth(int MaxDepth)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetAsyncCallStackDepthRequest(MaxDepth);
    }
    /// <summary>Enables or disables async call stacks tracking.</summary>
    /// <param name="MaxDepth">
    /// Maximum depth of async call stacks. Setting to `0` will effectively disable collecting async<br/>
    ...
    public static Enyim.Iris.Protocol.Debugger.SetBlackboxExecutionContextsRequest SetBlackboxExecutionContexts(System.Collections.Generic.IReadOnlyList<string> UniqueIds)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetBlackboxExecutionContextsRequest(UniqueIds);
    }
    /// <summary>
    /// Replace previous blackbox execution contexts with passed ones. Forces backend to skip<br/>
    /// stepping/pausing in scripts in these execution contexts. VM will try to leave blackboxed script by<br/>
    ...
    public static Enyim.Iris.Protocol.Debugger.SetBlackboxPatternsRequest SetBlackboxPatterns(System.Collections.Generic.IReadOnlyList<string> Patterns, bool? SkipAnonymous = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetBlackboxPatternsRequest(Patterns, SkipAnonymous);
    }
    /// <summary>
    /// Replace previous blackbox patterns with passed ones. Forces backend to skip stepping/pausing in<br/>
    /// scripts with url matching one of the patterns. VM will try to leave blackboxed script by<br/>
    ...
    public static Enyim.Iris.Protocol.Debugger.SetBlackboxedRangesRequest SetBlackboxedRanges(Enyim.Iris.Protocol.Runtime.ScriptIdType ScriptId, System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.ScriptPositionType> Positions)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetBlackboxedRangesRequest(ScriptId, Positions);
    }
    /// <summary>
    /// Makes backend skip steps in the script in blackboxed ranges. VM will try leave blacklisted<br/>
    /// scripts by performing &#39;step in&#39; several times, finally resorting to &#39;step out&#39; if unsuccessful.<br/>
    ...
    public record SetBlackboxedRangesRequest(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.ScriptPositionType> Positions
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Debugger.SetBreakpointRequest SetBreakpoint(Enyim.Iris.Protocol.Debugger.LocationType Location, string? Condition = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetBreakpointRequest(Location, Condition);
    }
    /// <summary>Sets JavaScript breakpoint at a given location.</summary>
    /// <param name="Location">Location to set breakpoint in.</param>
    /// <param name="Condition">
    ...
    public record SetBreakpointRequestResult(
      ...
      Enyim.Iris.Protocol.Debugger.LocationType ActualLocation
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>Sets instrumentation breakpoint.</summary>
    /// <param name="Instrumentation">Instrumentation name.</param>
    public static Enyim.Iris.Protocol.Debugger.SetInstrumentationBreakpointRequest SetInstrumentationBreakpoint(string Instrumentation)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetInstrumentationBreakpointRequest(Instrumentation);
    }
    /// <summary>Sets instrumentation breakpoint.</summary>
    /// <param name="Instrumentation">Instrumentation name.</param>
    ...
    /// breakpoint if this expression evaluates to true.<br/>
    /// </param>
    public static Enyim.Iris.Protocol.Debugger.SetBreakpointByUrlRequest SetBreakpointByUrl(int LineNumber, string? Url = default, string? UrlRegex = default, string? ScriptHash = default, int? ColumnNumber = default, string? Condition = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetBreakpointByUrlRequest(LineNumber, Url, UrlRegex, ScriptHash, ColumnNumber, Condition);
    }
    /// <summary>
    /// Sets JavaScript breakpoint at given location specified either by URL or URL regex. Once this<br/>
    /// command is issued, all existing parsed scripts will have breakpoints resolved and returned in<br/>
    ...
    public record SetBreakpointByUrlRequestResult(
      ...
      Enyim.Iris.Protocol.Debugger.BreakpointIdType BreakpointId,
      [property: System.Text.Json.Serialization.JsonPropertyName("locations")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.LocationType> Locations
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Debugger.SetBreakpointOnFunctionCallRequest SetBreakpointOnFunctionCall(Enyim.Iris.Protocol.Runtime.RemoteObjectIdType ObjectId, string? Condition = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetBreakpointOnFunctionCallRequest(ObjectId, Condition);
    }
    /// <summary>
    /// Sets JavaScript breakpoint before each call to the given function.<br/>
    /// If another function was created from the same source as a given one,<br/>
    ...
    public static Enyim.Iris.Protocol.Debugger.SetBreakpointsActiveRequest SetBreakpointsActive(bool Active)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetBreakpointsActiveRequest(Active);
    }
    /// <summary>Activates / deactivates all breakpoints on the page.</summary>
    /// <param name="Active">New value for breakpoints active state.</param>
    ...
    public static Enyim.Iris.Protocol.Debugger.SetPauseOnExceptionsRequest SetPauseOnExceptions(string State)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetPauseOnExceptionsRequest(State);
    }
    /// <summary>
    /// Defines pause on exceptions state. Can be set to stop on all exceptions, uncaught exceptions,<br/>
    /// or caught exceptions, no exceptions. Initial pause on exceptions state is `none`.<br/>
    ...
    public static Enyim.Iris.Protocol.Debugger.SetReturnValueRequest SetReturnValue(Enyim.Iris.Protocol.Runtime.CallArgumentType NewValue)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetReturnValueRequest(NewValue);
    }
    /// <summary>Changes return value in top frame. Available only at return break position.</summary>
    /// <param name="NewValue">New return value.</param>
    ...
    public record SetReturnValueRequest(
      ...
      Enyim.Iris.Protocol.Runtime.CallArgumentType NewValue
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Debugger.SetScriptSourceRequest SetScriptSource(Enyim.Iris.Protocol.Runtime.ScriptIdType ScriptId, string ScriptSource, bool? DryRun = default, bool? AllowTopFrameEditing = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetScriptSourceRequest(ScriptId, ScriptSource, DryRun, AllowTopFrameEditing);
    }
    /// <summary>
    /// Edits JavaScript source live.<br/>
    /// In general, functions that are currently on the stack can not be edited with<br/>
    ...
    public record SetScriptSourceRequestResult(
      ...
      [property: System.Obsolete("This property marked as deprecated in the corresponding CDP definition schema. It may be removed in the future releases.", false)]
      [property: System.Text.Json.Serialization.JsonPropertyName("callFrames")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.CallFrameType>? CallFrames = default,
      [property: System.Obsolete("This property marked as deprecated in the corresponding CDP definition schema. It may be removed in the future releases.", false)]
    ...
    public static Enyim.Iris.Protocol.Debugger.SetSkipAllPausesRequest SetSkipAllPauses(bool Skip)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetSkipAllPausesRequest(Skip);
    }
    /// <summary>Makes page not interrupt on any pauses (breakpoint, exception, dom exception etc).</summary>
    /// <param name="Skip">New value for skip pauses state.</param>
    ...
    public static Enyim.Iris.Protocol.Debugger.SetVariableValueRequest SetVariableValue(int ScopeNumber, string VariableName, Enyim.Iris.Protocol.Runtime.CallArgumentType NewValue, Enyim.Iris.Protocol.Debugger.CallFrameIdType CallFrameId)    
    {
      return new Enyim.Iris.Protocol.Debugger.SetVariableValueRequest(ScopeNumber, VariableName, NewValue, CallFrameId);
    }
    /// <summary>
    /// Changes value of variable in a callframe. Object-based scopes are not supported and must be<br/>
    /// mutated manually.<br/>
    ...
    public static Enyim.Iris.Protocol.Debugger.StepIntoRequest StepInto(bool? BreakOnAsyncCall = default, System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.LocationRangeType>? SkipList = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.StepIntoRequest(BreakOnAsyncCall, SkipList);
    }
    /// <summary>Steps into the function call.</summary>
    /// <param name="BreakOnAsyncCall">
    /// Debugger will pause on the execution of the first async task which was scheduled<br/>
    ...
    public record StepIntoRequest(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.LocationRangeType>? SkipList = default
    ...
    public static Enyim.Iris.Protocol.Debugger.StepOutRequest StepOut()    
    {
      return new Enyim.Iris.Protocol.Debugger.StepOutRequest();
    }
    /// <summary>Steps out of the function call.</summary>
    ...
    public static Enyim.Iris.Protocol.Debugger.StepOverRequest StepOver(System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Debugger.LocationRangeType>? SkipList = default)    
    {
      return new Enyim.Iris.Protocol.Debugger.StepOverRequest(SkipList);
    }
    /// <summary>Steps over the statement.</summary>
    /// <param name="SkipList">The skipList specifies location ranges that should be skipped on step over.</param>
