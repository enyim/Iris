...
namespace Enyim.Iris.Protocol
{
  public static partial class LayerTree
  {
    ...
    public record StickyPositionConstraintType(
      ...
      Enyim.Iris.Protocol.DOM.RectType StickyBoxRect,
      [property: System.Text.Json.Serialization.JsonPropertyName("containingBlockRect")]
      Enyim.Iris.Protocol.DOM.RectType ContainingBlockRect,
      [property: System.Text.Json.Serialization.JsonPropertyName("nearestLayerShiftingStickyBox")]
      Enyim.Iris.Protocol.LayerTree.LayerIdType? NearestLayerShiftingStickyBox = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("nearestLayerShiftingContainingBlock")]
      Enyim.Iris.Protocol.LayerTree.LayerIdType? NearestLayerShiftingContainingBlock = default
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record LayerType(
      ...
      Enyim.Iris.Protocol.LayerTree.LayerIdType LayerId,
      ...
      Enyim.Iris.Protocol.LayerTree.LayerIdType? ParentLayerId = default,
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.LayerTree.ScrollRectType>? ScrollRects = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("stickyPositionConstraint")]
      Enyim.Iris.Protocol.LayerTree.StickyPositionConstraintType? StickyPositionConstraint = default
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record LayerPainted(
      ...
      Enyim.Iris.Protocol.DOM.RectType Clip
    ...
    public record LayerTreeDidChange(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.LayerTree.LayerType>? Layers = default
    ) : ChromeProtocol.Core.IEvent
    {
    }
    ...
    public static Enyim.Iris.Protocol.LayerTree.CompositingReasonsRequest CompositingReasons(Enyim.Iris.Protocol.LayerTree.LayerIdType LayerId)    
    {
      return new Enyim.Iris.Protocol.LayerTree.CompositingReasonsRequest(LayerId);
    }
    /// <summary>Provides the reasons why the given layer was composited.</summary>
    /// <param name="LayerId">The id of the layer for which we want to get the reasons it was composited.</param>
    ...
    public static Enyim.Iris.Protocol.LayerTree.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.LayerTree.DisableRequest();
    }
    /// <summary>Disables compositing tree inspection.</summary>
    ...
    public static Enyim.Iris.Protocol.LayerTree.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.LayerTree.EnableRequest();
    }
    /// <summary>Enables compositing tree inspection.</summary>
    ...
    public static Enyim.Iris.Protocol.LayerTree.LoadSnapshotRequest LoadSnapshot(System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.LayerTree.PictureTileType> Tiles)    
    {
      return new Enyim.Iris.Protocol.LayerTree.LoadSnapshotRequest(Tiles);
    }
    /// <summary>Returns the snapshot identifier.</summary>
    /// <param name="Tiles">An array of tiles composing the snapshot.</param>
    ...
    public record LoadSnapshotRequest(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.LayerTree.PictureTileType> Tiles
    ...
    public record LoadSnapshotRequestResult(
      ...
      Enyim.Iris.Protocol.LayerTree.SnapshotIdType SnapshotId
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>Returns the layer snapshot identifier.</summary>
    /// <param name="LayerId">The id of the layer.</param>
    public static Enyim.Iris.Protocol.LayerTree.MakeSnapshotRequest MakeSnapshot(Enyim.Iris.Protocol.LayerTree.LayerIdType LayerId)    
    {
      return new Enyim.Iris.Protocol.LayerTree.MakeSnapshotRequest(LayerId);
    }
    /// <summary>Returns the layer snapshot identifier.</summary>
    /// <param name="LayerId">The id of the layer.</param>
    ...
    public static Enyim.Iris.Protocol.LayerTree.ProfileSnapshotRequest ProfileSnapshot(Enyim.Iris.Protocol.LayerTree.SnapshotIdType SnapshotId, int? MinRepeatCount = default, double? MinDuration = default, Enyim.Iris.Protocol.DOM.RectType? ClipRect = default)    
    {
      return new Enyim.Iris.Protocol.LayerTree.ProfileSnapshotRequest(SnapshotId, MinRepeatCount, MinDuration, ClipRect);
    }
    /// <param name="SnapshotId">The id of the layer snapshot.</param>
    /// <param name="MinRepeatCount">The maximum number of times to replay the snapshot (1, if not specified).</param>
    /// <param name="MinDuration">The minimum duration (in seconds) to replay the snapshot.</param>
    ...
    public record ProfileSnapshotRequest(
      ...
      Enyim.Iris.Protocol.DOM.RectType? ClipRect = default
    ...
    public record ProfileSnapshotRequestResult(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.LayerTree.PaintProfileType> Timings
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>Releases layer snapshot captured by the back-end.</summary>
    /// <param name="SnapshotId">The id of the layer snapshot.</param>
    public static Enyim.Iris.Protocol.LayerTree.ReleaseSnapshotRequest ReleaseSnapshot(Enyim.Iris.Protocol.LayerTree.SnapshotIdType SnapshotId)    
    {
      return new Enyim.Iris.Protocol.LayerTree.ReleaseSnapshotRequest(SnapshotId);
    }
    /// <summary>Releases layer snapshot captured by the back-end.</summary>
    /// <param name="SnapshotId">The id of the layer snapshot.</param>
    ...
    public static Enyim.Iris.Protocol.LayerTree.ReplaySnapshotRequest ReplaySnapshot(Enyim.Iris.Protocol.LayerTree.SnapshotIdType SnapshotId, int? FromStep = default, int? ToStep = default, double? Scale = default)    
    {
      return new Enyim.Iris.Protocol.LayerTree.ReplaySnapshotRequest(SnapshotId, FromStep, ToStep, Scale);
    }
    /// <summary>Replays the layer snapshot and returns the resulting bitmap.</summary>
    /// <param name="SnapshotId">The id of the layer snapshot.</param>
    /// <param name="FromStep">The first step to replay from (replay from the very start if not specified).</param>
    ...
    /// <param name="SnapshotId">The id of the layer snapshot.</param>
    public static Enyim.Iris.Protocol.LayerTree.SnapshotCommandLogRequest SnapshotCommandLog(Enyim.Iris.Protocol.LayerTree.SnapshotIdType SnapshotId)    
    {
      return new Enyim.Iris.Protocol.LayerTree.SnapshotCommandLogRequest(SnapshotId);
    }
    /// <summary>Replays the layer snapshot and returns canvas log.</summary>
    /// <param name="SnapshotId">The id of the layer snapshot.</param>
