...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class WebAuthn
  {
    ...
    /// Defaults to false.<br/>
    /// </param>
    /// <param name="HasHmacSecret">
    /// If set to true, the authenticator will support the hmac-secret extension.<br/>
    /// https://fidoalliance.org/specs/fido-v2.1-ps-20210615/fido-client-to-authenticator-protocol-v2.1-ps-20210615.html#sctn-hmac-secret-extension<br/>
    /// Defaults to false.<br/>
    /// </param>
    /// <param name="HasHmacSecretMc">
    /// If set to true, the authenticator will support the hmac-secret-mc extension.<br/>
    /// https://fidoalliance.org/specs/fido-v2.2-rd-20241003/fido-client-to-authenticator-protocol-v2.2-rd-20241003.html#sctn-hmac-secret-make-cred-extension<br/>
    /// Defaults to false.<br/>
    /// </param>
    ...
    public record VirtualAuthenticatorOptionsType(
      ...
      Enyim.Iris.Protocol.WebAuthn.AuthenticatorProtocolType Protocol,
      [property: System.Text.Json.Serialization.JsonPropertyName("transport")]
      Enyim.Iris.Protocol.WebAuthn.AuthenticatorTransportType Transport,
      [property: System.Text.Json.Serialization.JsonPropertyName("ctap2Version")]
      Enyim.Iris.Protocol.WebAuthn.Ctap2VersionType? Ctap2Version = default,
      ...
      bool? HasPrf = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("hasHmacSecret")]
      bool? HasHmacSecret = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("hasHmacSecretMc")]
      bool? HasHmacSecretMc = default,
    ...
    public record CredentialAdded(
      ...
      Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId,
      [property: System.Text.Json.Serialization.JsonPropertyName("credential")]
      Enyim.Iris.Protocol.WebAuthn.CredentialType Credential
    ...
    /// Defaults to false.<br/>
    /// </param>
    public static Enyim.Iris.Protocol.WebAuthn.EnableRequest Enable(bool? EnableUI = default)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.EnableRequest(EnableUI);
    }
    /// <summary>
    /// Enable the WebAuthn domain and start intercepting credential storage and<br/>
    /// retrieval with a virtual authenticator.<br/>
    ...
    public static Enyim.Iris.Protocol.WebAuthn.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.WebAuthn.DisableRequest();
    }
    /// <summary>Disable the WebAuthn domain.</summary>
    ...
    public static Enyim.Iris.Protocol.WebAuthn.AddVirtualAuthenticatorRequest AddVirtualAuthenticator(Enyim.Iris.Protocol.WebAuthn.VirtualAuthenticatorOptionsType Options)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.AddVirtualAuthenticatorRequest(Options);
    }
    /// <summary>Creates and adds a virtual authenticator.</summary>
    ...
    public record AddVirtualAuthenticatorRequest(
      ...
      Enyim.Iris.Protocol.WebAuthn.VirtualAuthenticatorOptionsType Options
    ...
    /// be zero. Defaults to false.<br/>
    /// </param>
    public static Enyim.Iris.Protocol.WebAuthn.SetResponseOverrideBitsRequest SetResponseOverrideBits(Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId, bool? IsBogusSignature = default, bool? IsBadUV = default, bool? IsBadUP = default)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.SetResponseOverrideBitsRequest(AuthenticatorId, IsBogusSignature, IsBadUV, IsBadUP);
    }
    /// <summary>Resets parameters isBogusSignature, isBadUV, isBadUP to false if they are not present.</summary>
    /// <param name="IsBogusSignature">
    /// If isBogusSignature is set, overrides the signature in the authenticator response to be zero.<br/>
    ...
    public static Enyim.Iris.Protocol.WebAuthn.RemoveVirtualAuthenticatorRequest RemoveVirtualAuthenticator(Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.RemoveVirtualAuthenticatorRequest(AuthenticatorId);
    }
    /// <summary>Removes the given authenticator.</summary>
    ...
    public static Enyim.Iris.Protocol.WebAuthn.AddCredentialRequest AddCredential(Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId, Enyim.Iris.Protocol.WebAuthn.CredentialType Credential)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.AddCredentialRequest(AuthenticatorId, Credential);
    }
    /// <summary>Adds the credential to the specified authenticator.</summary>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.WebAuthn.GetCredentialRequest GetCredential(Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId, string CredentialId)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.GetCredentialRequest(AuthenticatorId, CredentialId);
    }
    /// <summary>
    /// Returns a single credential stored in the given virtual authenticator that<br/>
    /// matches the credential ID.<br/>
    ...
    public static Enyim.Iris.Protocol.WebAuthn.GetCredentialsRequest GetCredentials(Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.GetCredentialsRequest(AuthenticatorId);
    }
    /// <summary>Returns all the credentials stored in the given virtual authenticator.</summary>
    ...
    public record GetCredentialsRequestResult(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.WebAuthn.CredentialType> Credentials
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>Removes a credential from the authenticator.</summary>
    public static Enyim.Iris.Protocol.WebAuthn.RemoveCredentialRequest RemoveCredential(Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId, string CredentialId)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.RemoveCredentialRequest(AuthenticatorId, CredentialId);
    }
    /// <summary>Removes a credential from the authenticator.</summary>
    ...
    public static Enyim.Iris.Protocol.WebAuthn.ClearCredentialsRequest ClearCredentials(Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.ClearCredentialsRequest(AuthenticatorId);
    }
    /// <summary>Clears all the credentials from the specified device.</summary>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.WebAuthn.SetUserVerifiedRequest SetUserVerified(Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId, bool IsUserVerified)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.SetUserVerifiedRequest(AuthenticatorId, IsUserVerified);
    }
    /// <summary>
    /// Sets whether User Verification succeeds or fails for an authenticator.<br/>
    /// The default is true.<br/>
    ...
    /// The default is true.<br/>
    /// </summary>
    public static Enyim.Iris.Protocol.WebAuthn.SetAutomaticPresenceSimulationRequest SetAutomaticPresenceSimulation(Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId, bool Enabled)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.SetAutomaticPresenceSimulationRequest(AuthenticatorId, Enabled);
    }
    /// <summary>
    /// Sets whether tests of user presence will succeed immediately (if true) or fail to resolve (if false) for an authenticator.<br/>
    /// The default is true.<br/>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.WebAuthn.SetCredentialPropertiesRequest SetCredentialProperties(Enyim.Iris.Protocol.WebAuthn.AuthenticatorIdType AuthenticatorId, string CredentialId, bool? BackupEligibility = default, bool? BackupState = default)    
    {
      return new Enyim.Iris.Protocol.WebAuthn.SetCredentialPropertiesRequest(AuthenticatorId, CredentialId, BackupEligibility, BackupState);
    }
    /// <summary>
    /// Allows setting credential properties.<br/>
    /// https://w3c.github.io/webauthn/#sctn-automation-set-credential-properties<br/>
