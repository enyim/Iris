...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class SystemInfo
  {
    ...
    public record VideoDecodeAcceleratorCapabilityType(
      ...
      Enyim.Iris.Protocol.SystemInfo.SizeType MaxResolution,
      [property: System.Text.Json.Serialization.JsonPropertyName("minResolution")]
      Enyim.Iris.Protocol.SystemInfo.SizeType MinResolution
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>
    ...
    public record GPUInfoType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.SystemInfo.GPUDeviceType> Devices,
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.SystemInfo.VideoDecodeAcceleratorCapabilityType> VideoDecoding,
      [property: System.Text.Json.Serialization.JsonPropertyName("videoEncoding")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.SystemInfo.VideoEncodeAcceleratorCapabilityType> VideoEncoding,
    ...
    public static Enyim.Iris.Protocol.SystemInfo.GetInfoRequest GetInfo()    
    {
      return new Enyim.Iris.Protocol.SystemInfo.GetInfoRequest();
    }
    /// <summary>Returns information about the system.</summary>
    ...
    public record GetInfoRequestResult(
      ...
      Enyim.Iris.Protocol.SystemInfo.GPUInfoType Gpu,
    ...
    public static Enyim.Iris.Protocol.SystemInfo.GetFeatureStateRequest GetFeatureState(string FeatureState)    
    {
      return new Enyim.Iris.Protocol.SystemInfo.GetFeatureStateRequest(FeatureState);
    }
    /// <summary>Returns information about the feature state.</summary>
    ...
    public static Enyim.Iris.Protocol.SystemInfo.GetProcessInfoRequest GetProcessInfo()    
    {
      return new Enyim.Iris.Protocol.SystemInfo.GetProcessInfoRequest();
    }
    /// <summary>Returns information about all running processes.</summary>
    ...
    public record GetProcessInfoRequestResult(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.SystemInfo.ProcessInfoType> ProcessInfo
    ) : ChromeProtocol.Core.IType
    {
    }
  }
