...
namespace Enyim.Iris.Protocol
{
  public static partial class Accessibility
  {
    ...
    public record AXValueSourceType(
      ...
      Enyim.Iris.Protocol.Accessibility.AXValueSourceTypeType Type,
      [property: System.Text.Json.Serialization.JsonPropertyName("value")]
      Enyim.Iris.Protocol.Accessibility.AXValueType? Value = default,
      ...
      Enyim.Iris.Protocol.Accessibility.AXValueType? AttributeValue = default,
      ...
      Enyim.Iris.Protocol.Accessibility.AXValueNativeSourceTypeType? NativeSource = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("nativeSourceValue")]
      Enyim.Iris.Protocol.Accessibility.AXValueType? NativeSourceValue = default,
    ...
    public record AXRelatedNodeType(
      ...
      Enyim.Iris.Protocol.DOM.BackendNodeIdType BackendDOMNodeId,
    ...
    public record AXPropertyType(
      ...
      Enyim.Iris.Protocol.Accessibility.AXPropertyNameType Name,
      [property: System.Text.Json.Serialization.JsonPropertyName("value")]
      Enyim.Iris.Protocol.Accessibility.AXValueType Value
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record AXValueType(
      [property: System.Text.Json.Serialization.JsonPropertyName("type")]
      Enyim.Iris.Protocol.Accessibility.AXValueTypeType Type,
      [property: System.Text.Json.Serialization.JsonPropertyName("value")]
      System.Text.Json.Nodes.JsonNode? Value = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("relatedNodes")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Accessibility.AXRelatedNodeType>? RelatedNodes = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("sources")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Accessibility.AXValueSourceType>? Sources = default
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>
    ...
    /// - from &#39;activeFullscreenElement&#39; to &#39;uninteresting&#39;: reasons why this noode is hidden<br/>
    /// </summary>
    [System.Text.Json.Serialization.JsonConverter(typeof(ChromeProtocol.Core.PrimitiveTypeConverter))]
    ...
    public record AXNodeType(
      ...
      Enyim.Iris.Protocol.Accessibility.AXNodeIdType NodeId,
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Accessibility.AXPropertyType>? IgnoredReasons = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("role")]
      Enyim.Iris.Protocol.Accessibility.AXValueType? Role = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("chromeRole")]
      Enyim.Iris.Protocol.Accessibility.AXValueType? ChromeRole = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("name")]
      Enyim.Iris.Protocol.Accessibility.AXValueType? Name = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("description")]
      Enyim.Iris.Protocol.Accessibility.AXValueType? Description = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("value")]
      Enyim.Iris.Protocol.Accessibility.AXValueType? Value = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("properties")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Accessibility.AXPropertyType>? Properties = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("parentId")]
      Enyim.Iris.Protocol.Accessibility.AXNodeIdType? ParentId = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("childIds")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Accessibility.AXNodeIdType>? ChildIds = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("backendDOMNodeId")]
      Enyim.Iris.Protocol.DOM.BackendNodeIdType? BackendDOMNodeId = default,
    ...
    public record LoadComplete(
      ...
      Enyim.Iris.Protocol.Accessibility.AXNodeType Root
    ...
    public record NodesUpdated(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Accessibility.AXNodeType> Nodes
    ) : ChromeProtocol.Core.IEvent
    {
    }
    /// <summary>Disables the accessibility domain.</summary>
    public static Enyim.Iris.Protocol.Accessibility.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Accessibility.DisableRequest();
    }
    /// <summary>Disables the accessibility domain.</summary>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Accessibility.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.Accessibility.EnableRequest();
    }
    /// <summary>
    /// Enables the accessibility domain which causes `AXNodeId`s to remain consistent between method calls.<br/>
    /// This turns on accessibility for the page, which can impact performance until accessibility is disabled.<br/>
    ...
    public static Enyim.Iris.Protocol.Accessibility.GetPartialAXTreeRequest GetPartialAXTree(Enyim.Iris.Protocol.DOM.NodeIdType? NodeId = default, Enyim.Iris.Protocol.DOM.BackendNodeIdType? BackendNodeId = default, Enyim.Iris.Protocol.Runtime.RemoteObjectIdType? ObjectId = default, bool? FetchRelatives = default)    
    {
      return new Enyim.Iris.Protocol.Accessibility.GetPartialAXTreeRequest(NodeId, BackendNodeId, ObjectId, FetchRelatives);
    }
    /// <summary>Fetches the accessibility node and partial accessibility tree for this DOM node, if it exists.</summary>
    /// <param name="NodeId">Identifier of the node to get the partial accessibility tree for.</param>
    /// <param name="BackendNodeId">Identifier of the backend node to get the partial accessibility tree for.</param>
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Accessibility.GetFullAXTreeRequest GetFullAXTree(int? Depth = default, Enyim.Iris.Protocol.Page.FrameIdType? FrameId = default)    
    {
      return new Enyim.Iris.Protocol.Accessibility.GetFullAXTreeRequest(Depth, FrameId);
    }
    /// <summary>Fetches the entire accessibility tree for the root Document</summary>
    /// <param name="Depth">
    /// The maximum depth at which descendants of the root node should be retrieved.<br/>
    ...
    /// If omitted, the root frame is used.<br/>
    /// </param>
    public static Enyim.Iris.Protocol.Accessibility.GetRootAXNodeRequest GetRootAXNode(Enyim.Iris.Protocol.Page.FrameIdType? FrameId = default)    
    {
      return new Enyim.Iris.Protocol.Accessibility.GetRootAXNodeRequest(FrameId);
    }
    /// <summary>
    /// Fetches the root node.<br/>
    /// Requires `enable()` to have been called previously.<br/>
    ...
    public record GetRootAXNodeRequestResult(
      ...
      Enyim.Iris.Protocol.Accessibility.AXNodeType Node
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>
    ...
    public static Enyim.Iris.Protocol.Accessibility.GetAXNodeAndAncestorsRequest GetAXNodeAndAncestors(Enyim.Iris.Protocol.DOM.NodeIdType? NodeId = default, Enyim.Iris.Protocol.DOM.BackendNodeIdType? BackendNodeId = default, Enyim.Iris.Protocol.Runtime.RemoteObjectIdType? ObjectId = default)    
    {
      return new Enyim.Iris.Protocol.Accessibility.GetAXNodeAndAncestorsRequest(NodeId, BackendNodeId, ObjectId);
    }
    /// <summary>
    /// Fetches a node and all ancestors up to and including the root.<br/>
    /// Requires `enable()` to have been called previously.<br/>
    ...
    /// If omitted, the root frame is used.<br/>
    /// </param>
    public static Enyim.Iris.Protocol.Accessibility.GetChildAXNodesRequest GetChildAXNodes(Enyim.Iris.Protocol.Accessibility.AXNodeIdType Id, Enyim.Iris.Protocol.Page.FrameIdType? FrameId = default)    
    {
      return new Enyim.Iris.Protocol.Accessibility.GetChildAXNodesRequest(Id, FrameId);
    }
    /// <summary>
    /// Fetches a particular accessibility node by AXNodeId.<br/>
    /// Requires `enable()` to have been called previously.<br/>
    ...
    public record GetChildAXNodesRequest(
      ...
      Enyim.Iris.Protocol.Accessibility.AXNodeIdType Id,
      [property: System.Text.Json.Serialization.JsonPropertyName("frameId")]
      Enyim.Iris.Protocol.Page.FrameIdType? FrameId = default
    ...
    public static Enyim.Iris.Protocol.Accessibility.QueryAXTreeRequest QueryAXTree(Enyim.Iris.Protocol.DOM.NodeIdType? NodeId = default, Enyim.Iris.Protocol.DOM.BackendNodeIdType? BackendNodeId = default, Enyim.Iris.Protocol.Runtime.RemoteObjectIdType? ObjectId = default, string? AccessibleName = default, string? Role = default)    
    {
      return new Enyim.Iris.Protocol.Accessibility.QueryAXTreeRequest(NodeId, BackendNodeId, ObjectId, AccessibleName, Role);
    }
    /// <summary>
    /// Query a DOM node&#39;s accessibility subtree for accessible name and role.<br/>
    /// This command computes the name and role for all nodes in the subtree, including those that are<br/>
