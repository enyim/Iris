...
namespace Enyim.Iris.Protocol
{
  public static partial class Memory
  {
    ...
    public record SamplingProfileType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Memory.SamplingProfileNodeType> Samples,
      [property: System.Text.Json.Serialization.JsonPropertyName("modules")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Memory.ModuleType> Modules
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public static Enyim.Iris.Protocol.Memory.GetDOMCountersRequest GetDOMCounters()    
    {
      return new Enyim.Iris.Protocol.Memory.GetDOMCountersRequest();
    }
    /// <summary>Retruns current DOM object counters.</summary>
    ...
    public static Enyim.Iris.Protocol.Memory.GetDOMCountersForLeakDetectionRequest GetDOMCountersForLeakDetection()    
    {
      return new Enyim.Iris.Protocol.Memory.GetDOMCountersForLeakDetectionRequest();
    }
    /// <summary>Retruns DOM object counters after preparing renderer for leak detection.</summary>
    ...
    public record GetDOMCountersForLeakDetectionRequestResult(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Memory.DOMCounterType> Counters
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Memory.PrepareForLeakDetectionRequest PrepareForLeakDetection()    
    {
      return new Enyim.Iris.Protocol.Memory.PrepareForLeakDetectionRequest();
    }
    /// <summary>
    /// Prepares for leak detection by terminating workers, stopping spellcheckers,<br/>
    /// dropping non-essential internal caches, running garbage collections, etc.<br/>
    ...
    public static Enyim.Iris.Protocol.Memory.ForciblyPurgeJavaScriptMemoryRequest ForciblyPurgeJavaScriptMemory()    
    {
      return new Enyim.Iris.Protocol.Memory.ForciblyPurgeJavaScriptMemoryRequest();
    }
    /// <summary>Simulate OomIntervention by purging V8 memory.</summary>
    ...
    public static Enyim.Iris.Protocol.Memory.SetPressureNotificationsSuppressedRequest SetPressureNotificationsSuppressed(bool Suppressed)    
    {
      return new Enyim.Iris.Protocol.Memory.SetPressureNotificationsSuppressedRequest(Suppressed);
    }
    /// <summary>Enable/disable suppressing memory pressure notifications in all processes.</summary>
    /// <param name="Suppressed">If true, memory pressure notifications will be suppressed.</param>
    ...
    public static Enyim.Iris.Protocol.Memory.SimulatePressureNotificationRequest SimulatePressureNotification(Enyim.Iris.Protocol.Memory.PressureLevelType Level)    
    {
      return new Enyim.Iris.Protocol.Memory.SimulatePressureNotificationRequest(Level);
    }
    /// <summary>Simulate a memory pressure notification in all processes.</summary>
    /// <param name="Level">Memory pressure level of the notification.</param>
    ...
    public record SimulatePressureNotificationRequest(
      ...
      Enyim.Iris.Protocol.Memory.PressureLevelType Level
    ...
    public static Enyim.Iris.Protocol.Memory.StartSamplingRequest StartSampling(int? SamplingInterval = default, bool? SuppressRandomness = default)    
    {
      return new Enyim.Iris.Protocol.Memory.StartSamplingRequest(SamplingInterval, SuppressRandomness);
    }
    /// <summary>Start collecting native memory profile.</summary>
    /// <param name="SamplingInterval">Average number of bytes between samples.</param>
    /// <param name="SuppressRandomness">Do not randomize intervals between samples.</param>
    ...
    public static Enyim.Iris.Protocol.Memory.StopSamplingRequest StopSampling()    
    {
      return new Enyim.Iris.Protocol.Memory.StopSamplingRequest();
    }
    /// <summary>Stop collecting native memory profile.</summary>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Memory.GetAllTimeSamplingProfileRequest GetAllTimeSamplingProfile()    
    {
      return new Enyim.Iris.Protocol.Memory.GetAllTimeSamplingProfileRequest();
    }
    /// <summary>
    /// Retrieve native memory allocations profile<br/>
    /// collected since renderer process startup.<br/>
    ...
    public record GetAllTimeSamplingProfileRequestResult(
      ...
      Enyim.Iris.Protocol.Memory.SamplingProfileType Profile
    ) : ChromeProtocol.Core.IType
    {
    }
    /// <summary>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Memory.GetBrowserSamplingProfileRequest GetBrowserSamplingProfile()    
    {
      return new Enyim.Iris.Protocol.Memory.GetBrowserSamplingProfileRequest();
    }
    /// <summary>
    /// Retrieve native memory allocations profile<br/>
    /// collected since browser process startup.<br/>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Memory.GetSamplingProfileRequest GetSamplingProfile()    
    {
      return new Enyim.Iris.Protocol.Memory.GetSamplingProfileRequest();
    }
    /// <summary>
    /// Retrieve native memory allocations profile collected since last<br/>
    /// `startSampling` call.<br/>
