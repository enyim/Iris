...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class PerformanceTimeline
  {
    ...
    public record LargestContentfulPaintType(
      ...
      Enyim.Iris.Protocol.Network.TimeSinceEpochType RenderTime,
      [property: System.Text.Json.Serialization.JsonPropertyName("loadTime")]
      Enyim.Iris.Protocol.Network.TimeSinceEpochType LoadTime,
    ...
    public record LayoutShiftAttributionType(
      ...
      Enyim.Iris.Protocol.DOM.RectType PreviousRect,
      [property: System.Text.Json.Serialization.JsonPropertyName("currentRect")]
      Enyim.Iris.Protocol.DOM.RectType CurrentRect,
      [property: System.Text.Json.Serialization.JsonPropertyName("nodeId")]
      Enyim.Iris.Protocol.DOM.BackendNodeIdType? NodeId = default
    ) : ChromeProtocol.Core.IType
    {
    ...
    public record LayoutShiftType(
      ...
      Enyim.Iris.Protocol.Network.TimeSinceEpochType LastInputTime,
      [property: System.Text.Json.Serialization.JsonPropertyName("sources")]
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.PerformanceTimeline.LayoutShiftAttributionType> Sources
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record TimelineEventType(
      ...
      Enyim.Iris.Protocol.Network.TimeSinceEpochType Time,
      ...
      Enyim.Iris.Protocol.PerformanceTimeline.LargestContentfulPaintType? LcpDetails = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("layoutShiftDetails")]
      Enyim.Iris.Protocol.PerformanceTimeline.LayoutShiftType? LayoutShiftDetails = default
    ) : ChromeProtocol.Core.IType
    {
    }
    ...
    public record TimelineEventAdded(
      ...
      Enyim.Iris.Protocol.PerformanceTimeline.TimelineEventType Event
    ...
    /// </param>
    public static Enyim.Iris.Protocol.PerformanceTimeline.EnableRequest Enable(System.Collections.Generic.IReadOnlyList<string> EventTypes)    
    {
      return new Enyim.Iris.Protocol.PerformanceTimeline.EnableRequest(EventTypes);
    }
    /// <summary>
    /// Previously buffered events would be reported before method returns.<br/>
    /// See also: timelineEventAdded<br/>
