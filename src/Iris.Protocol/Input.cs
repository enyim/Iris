...
namespace Enyim.Iris.Protocol
{
  public static partial class Input
  {
    ...
    public record DragDataType(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Input.DragDataItemType> Items,
    ...
    public record DragIntercepted(
      [property: System.Text.Json.Serialization.JsonPropertyName("data")]
      Enyim.Iris.Protocol.Input.DragDataType Data
    ...
    /// (default: 0).<br/>
    /// </param>
    public static Enyim.Iris.Protocol.Input.DispatchDragEventRequest DispatchDragEvent(string Type, double X, double Y, Enyim.Iris.Protocol.Input.DragDataType Data, int? Modifiers = default)    
    {
      return new Enyim.Iris.Protocol.Input.DispatchDragEventRequest(Type, X, Y, Data, Modifiers);
    }
    /// <summary>Dispatches a drag event into the page.</summary>
    /// <param name="Type">Type of the drag event.</param>
    /// <param name="X">X coordinate of the event relative to the main frame&#39;s viewport in CSS pixels.</param>
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Input.DispatchKeyEventRequest DispatchKeyEvent(string Type, int? Modifiers = default, Enyim.Iris.Protocol.Input.TimeSinceEpochType? Timestamp = default, string? Text = default, string? UnmodifiedText = default, string? KeyIdentifier = default, string? Code = default, string? Key = default, int? WindowsVirtualKeyCode = default, int? NativeVirtualKeyCode = default, bool? AutoRepeat = default, bool? IsKeypad = default, bool? IsSystemKey = default, int? Location = default, System.Collections.Generic.IReadOnlyList<string>? Commands = default)    
    {
      return new Enyim.Iris.Protocol.Input.DispatchKeyEventRequest(Type, Modifiers, Timestamp, Text, UnmodifiedText, KeyIdentifier, Code, Key, WindowsVirtualKeyCode, NativeVirtualKeyCode, AutoRepeat, IsKeypad, IsSystemKey, Location, Commands);
    }
    /// <summary>Dispatches a key event to the page.</summary>
    /// <param name="Type">Type of the key event.</param>
    /// <param name="Modifiers">
    ...
    public record DispatchKeyEventRequest(
      ...
      Enyim.Iris.Protocol.Input.TimeSinceEpochType? Timestamp = default,
    ...
    public static Enyim.Iris.Protocol.Input.InsertTextRequest InsertText(string Text)    
    {
      return new Enyim.Iris.Protocol.Input.InsertTextRequest(Text);
    }
    /// <summary>
    /// This method emulates inserting text that doesn&#39;t come from a key press,<br/>
    /// for example an emoji keyboard or an IME.<br/>
    ...
    public static Enyim.Iris.Protocol.Input.ImeSetCompositionRequest ImeSetComposition(string Text, int SelectionStart, int SelectionEnd, int? ReplacementStart = default, int? ReplacementEnd = default)    
    {
      return new Enyim.Iris.Protocol.Input.ImeSetCompositionRequest(Text, SelectionStart, SelectionEnd, ReplacementStart, ReplacementEnd);
    }
    /// <summary>
    /// This method sets the current candidate text for IME.<br/>
    /// Use imeCommitComposition to commit the final text.<br/>
    ...
    public static Enyim.Iris.Protocol.Input.DispatchMouseEventRequest DispatchMouseEvent(string Type, double X, double Y, int? Modifiers = default, Enyim.Iris.Protocol.Input.TimeSinceEpochType? Timestamp = default, Enyim.Iris.Protocol.Input.MouseButtonType? Button = default, int? Buttons = default, int? ClickCount = default, double? Force = default, double? TangentialPressure = default, double? TiltX = default, double? TiltY = default, int? Twist = default, double? DeltaX = default, double? DeltaY = default, string? PointerType = default)    
    {
      return new Enyim.Iris.Protocol.Input.DispatchMouseEventRequest(Type, X, Y, Modifiers, Timestamp, Button, Buttons, ClickCount, Force, TangentialPressure, TiltX, TiltY, Twist, DeltaX, DeltaY, PointerType);
    }
    /// <summary>Dispatches a mouse event to the page.</summary>
    /// <param name="Type">Type of the mouse event.</param>
    /// <param name="X">X coordinate of the event relative to the main frame&#39;s viewport in CSS pixels.</param>
    ...
    public record DispatchMouseEventRequest(
      ...
      Enyim.Iris.Protocol.Input.MouseButtonType? Button = default,
    ...
    /// </param>
    /// <param name="Timestamp">Time at which the event occurred.</param>
    public static Enyim.Iris.Protocol.Input.DispatchTouchEventRequest DispatchTouchEvent(string Type, System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Input.TouchPointType> TouchPoints, int? Modifiers = default, Enyim.Iris.Protocol.Input.TimeSinceEpochType? Timestamp = default)    
    {
      return new Enyim.Iris.Protocol.Input.DispatchTouchEventRequest(Type, TouchPoints, Modifiers, Timestamp);
    }
    /// <summary>Dispatches a touch event to the page.</summary>
    /// <param name="Type">
    /// Type of the touch event. TouchEnd and TouchCancel must not contain any touch points, while<br/>
    ...
    public record DispatchTouchEventRequest(
      ...
      System.Collections.Generic.IReadOnlyList<Enyim.Iris.Protocol.Input.TouchPointType> TouchPoints,
      [property: System.Text.Json.Serialization.JsonPropertyName("modifiers")]
      int? Modifiers = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("timestamp")]
      Enyim.Iris.Protocol.Input.TimeSinceEpochType? Timestamp = default
    ...
    public static Enyim.Iris.Protocol.Input.CancelDraggingRequest CancelDragging()    
    {
      return new Enyim.Iris.Protocol.Input.CancelDraggingRequest();
    }
    /// <summary>Cancels any active dragging in the page.</summary>
    ...
    /// </param>
    /// <param name="ClickCount">Number of times the mouse button was clicked (default: 0).</param>
    public static Enyim.Iris.Protocol.Input.EmulateTouchFromMouseEventRequest EmulateTouchFromMouseEvent(string Type, int X, int Y, Enyim.Iris.Protocol.Input.MouseButtonType Button, Enyim.Iris.Protocol.Input.TimeSinceEpochType? Timestamp = default, double? DeltaX = default, double? DeltaY = default, int? Modifiers = default, int? ClickCount = default)    
    {
      return new Enyim.Iris.Protocol.Input.EmulateTouchFromMouseEventRequest(Type, X, Y, Button, Timestamp, DeltaX, DeltaY, Modifiers, ClickCount);
    }
    /// <summary>Emulates touch event from the mouse event parameters.</summary>
    /// <param name="Type">Type of the mouse event.</param>
    /// <param name="X">X coordinate of the mouse pointer in DIP.</param>
    ...
    public record EmulateTouchFromMouseEventRequest(
      ...
      int Y,
      [property: System.Text.Json.Serialization.JsonPropertyName("button")]
      Enyim.Iris.Protocol.Input.MouseButtonType Button,
      [property: System.Text.Json.Serialization.JsonPropertyName("timestamp")]
      Enyim.Iris.Protocol.Input.TimeSinceEpochType? Timestamp = default,
      [property: System.Text.Json.Serialization.JsonPropertyName("deltaX")]
      double? DeltaX = default,
    ...
    public static Enyim.Iris.Protocol.Input.SetIgnoreInputEventsRequest SetIgnoreInputEvents(bool Ignore)    
    {
      return new Enyim.Iris.Protocol.Input.SetIgnoreInputEventsRequest(Ignore);
    }
    /// <summary>Ignores input events (useful while auditing page).</summary>
    /// <param name="Ignore">Ignores input events processing when set to true.</param>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Input.SetInterceptDragsRequest SetInterceptDrags(bool Enabled)    
    {
      return new Enyim.Iris.Protocol.Input.SetInterceptDragsRequest(Enabled);
    }
    /// <summary>
    /// Prevents default drag and drop behavior and instead emits `Input.dragIntercepted` events.<br/>
    /// Drag and drop behavior can be directly controlled via `Input.dispatchDragEvent`.<br/>
    ...
    /// </param>
    public static Enyim.Iris.Protocol.Input.SynthesizePinchGestureRequest SynthesizePinchGesture(double X, double Y, double ScaleFactor, int? RelativeSpeed = default, Enyim.Iris.Protocol.Input.GestureSourceTypeType? GestureSourceType = default)    
    {
      return new Enyim.Iris.Protocol.Input.SynthesizePinchGestureRequest(X, Y, ScaleFactor, RelativeSpeed, GestureSourceType);
    }
    /// <summary>Synthesizes a pinch gesture over a time period by issuing appropriate touch events.</summary>
    /// <param name="X">X coordinate of the start of the gesture in CSS pixels.</param>
    /// <param name="Y">Y coordinate of the start of the gesture in CSS pixels.</param>
    ...
    public record SynthesizePinchGestureRequest(
      ...
      Enyim.Iris.Protocol.Input.GestureSourceTypeType? GestureSourceType = default
    ...
    public static Enyim.Iris.Protocol.Input.SynthesizeScrollGestureRequest SynthesizeScrollGesture(double X, double Y, double? XDistance = default, double? YDistance = default, double? XOverscroll = default, double? YOverscroll = default, bool? PreventFling = default, int? Speed = default, Enyim.Iris.Protocol.Input.GestureSourceTypeType? GestureSourceType = default, int? RepeatCount = default, int? RepeatDelayMs = default, string? InteractionMarkerName = default)    
    {
      return new Enyim.Iris.Protocol.Input.SynthesizeScrollGestureRequest(X, Y, XDistance, YDistance, XOverscroll, YOverscroll, PreventFling, Speed, GestureSourceType, RepeatCount, RepeatDelayMs, InteractionMarkerName);
    }
    /// <summary>Synthesizes a scroll gesture over a time period by issuing appropriate touch events.</summary>
    /// <param name="X">X coordinate of the start of the gesture in CSS pixels.</param>
    /// <param name="Y">Y coordinate of the start of the gesture in CSS pixels.</param>
    ...
    /// for the preferred input type).<br/>
    /// </param>
    public static Enyim.Iris.Protocol.Input.SynthesizeTapGestureRequest SynthesizeTapGesture(double X, double Y, int? Duration = default, int? TapCount = default, Enyim.Iris.Protocol.Input.GestureSourceTypeType? GestureSourceType = default)    
    {
      return new Enyim.Iris.Protocol.Input.SynthesizeTapGestureRequest(X, Y, Duration, TapCount, GestureSourceType);
    }
    /// <summary>Synthesizes a tap gesture over a time period by issuing appropriate touch events.</summary>
    /// <param name="X">X coordinate of the start of the gesture in CSS pixels.</param>
    /// <param name="Y">Y coordinate of the start of the gesture in CSS pixels.</param>
