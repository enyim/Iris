...
namespace Enyim.Iris.Protocol
{
  ...
  public static partial class Console
  {
    ...
    public record MessageAdded(
      ...
      Enyim.Iris.Protocol.Console.ConsoleMessageType Message
    ) : ChromeProtocol.Core.IEvent
    {
    }
    /// <summary>Does nothing.</summary>
    public static Enyim.Iris.Protocol.Console.ClearMessagesRequest ClearMessages()    
    {
      return new Enyim.Iris.Protocol.Console.ClearMessagesRequest();
    }
    /// <summary>Does nothing.</summary>
    ...
    public static Enyim.Iris.Protocol.Console.DisableRequest Disable()    
    {
      return new Enyim.Iris.Protocol.Console.DisableRequest();
    }
    /// <summary>Disables console domain, prevents further console messages from being reported to the client.</summary>
    ...
    /// </summary>
    public static Enyim.Iris.Protocol.Console.EnableRequest Enable()    
    {
      return new Enyim.Iris.Protocol.Console.EnableRequest();
    }
    /// <summary>
    /// Enables console domain, sends the messages collected so far to the client by means of the<br/>
    /// `messageAdded` notification.<br/>
